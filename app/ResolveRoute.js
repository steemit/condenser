export default function resolveRoute(path)
{
    ...
    match = path.match(/^\/(@[\w\.\d-]+)\/?$/) ||
        ...
        path.match(/^\/(@[\w\.\d-]+)\/(blog|resteemed|posts|comments|recommended|transfers|curation-rewards|author-rewards|permissions|created|recent-replies|feed|password|followed|followers|settings)\/?$/);
    if (match) {

            ...
            <form onSubmit={handleSubmit(data => onKeyChanged(data))}>
                <div className="row">
                    <div className={
                        ...
                        <input ref="key" type="password" {...cleanReduxInput(
                            password
                    ...
                    <div className={
                        ...
                        <input ref="keyConfirm" type="password" {...cleanReduxInput(
                            confirm
                        )} disabled={
                            isWif
...
const keyValidate = values => ({
    password: !values.password
        ...
        : values.password.length < 32
            ? translate("password_must_be_characters_or_more", { amount: 32 })
            : PublicKey.fromString(values.password)
                ? translate("need_password_or_key")
                : null,
    confirm: values.confirm !== values.password

...
export default class LandingFaq extends React.Component {
	render() {
		const elements = [
			...
			// следующие два вопроса были добавлены от балды из фака для тестов
			{
			...
			{
				title: 'Когда будет доступна регистрация новым пользователям?',
				content: '15 октября 2016 года с момента начала краудсейла.'
			}

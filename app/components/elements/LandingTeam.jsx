			...
			<section>
				...
				<div className="row">
					<div className="small-6 medium-4 large-3 columns">
						<img src="images/landing/Marina.jpg" alt="фотография Марины Гуревой" />
					...
					<div className="small-6 medium-4 large-3 columns">
						<img src="https://avatars2.githubusercontent.com/u/410789?v=3&s=400" alt="фотография Димы Стародубцева" />
					...
					<div className="small-6 medium-4 large-3 columns">
						<img src="https://avatars1.githubusercontent.com/u/1690657?v=3&s=400" alt="фотография Валерия Литвина" />
					...
					<div className="small-6 medium-4 large-3 columns">
						<img src="https://s3.amazonaws.com/keybase_processed_uploads/bc86969a26560b7a081d1f720f6f3c05_360_360_square_360.jpeg" alt="фотография Виталия Львова" />
					...
					<div className="small-6 medium-4 large-3 columns">
						<img src="images/landing/kostya.jpg" alt="фотография Контстантина Ломашука" />
						<strong>Константин Ломашук</strong>
						<p>Сооснователь cyber.fund</p>
						<ul>
					...
					<div className="small-6 medium-4 large-3 columns">
						<img src="https://pp.vk.me/c619721/v619721379/1de32/S_1velJqxSA.jpg" alt="фотография Михаила Палей" />

                        ...
                        <div className="row">
                            ...
                            <div className="column large-3 medium-3 small-6">
                                ...
                                <p className="landing-start-block-icon-text">
                                    ...
                                    оценивает и комментирует публикации
                                </p>
                            </div>
                            <div className="column large-3 medium-3 small-6">
                                ...
                                <p className="landing-start-block-icon-text">
                                    ...
                                    выложите фотографию любимого кота
                                </p>
                            </div>
                            <div className="column large-3 medium-3 small-6">
                                ...
                                <p className="landing-start-block-icon-text">
                                    ...
                                    пользователей принадлежит только им
                                </p>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="column large-9 medium-9 small-9">
                                    <p className="landing-start-block-text">
                                        «Считаем «Голос» перспективным проектом и постараемся
                                        привлечь на него как можно больше пользователей»
                                    </p>
                                </div>
                                <div className="landing-start-block-center column large-12 medium-12 small-12">
                                    <a href="/create_account" className="button">
                        ...
                        <div className="row">
                            <div className="column large-12 medium-12 small-12">
                                <p className="landing-start-block-text reg landing-start-block-center">
                                    чтобы начать делиться своими историями, подписываться на
                                    интересных авторов, оценивать публикации, знакомиться и получать
                                    вознаграждения
                                </p>
                            </div>
        ...
        if (simple) {
            ...
            return (
                <p className="landing-start-block-text">
                    ...
                    <span data-tooltip="Майнинг — деятельность по поддержанию блокчейна">
                        намайненое
                    </span>{' '}

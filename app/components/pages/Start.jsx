...
class Start extends React.Component {
    ...
    render() {
        ...
        let difAnswer = <p className='landing-start-block-text'>
            Каждый день мы отдаем все <span data-tip='Майнинг — деятельность по поддержанию блокчейна'>намайненое</span> в пул вознаграждения авторов. Он распределяется в зависимости от количества

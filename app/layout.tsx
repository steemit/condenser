...
export default async function RootLayout({
  ...
  // Per-request CSP nonce, generated by proxy.ts (see lib/csp.ts). Next.js
  // stamps it on the framework/bootstrap scripts automatically from the
  // request's Content-Security-Policy header; the tags below are plain JSX,

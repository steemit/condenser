...
const en = 	{
  ...
  in_order_to_prevent_abuse_APP_NAME_can_only_register_one_account_per_verified_user: 'In order to prevent abuse ' + APP_NAME + ' can only register one account per verified user',
  ...
  this_password_or_private_key_was_entered_incorrectly_there_is_probably_a_handwriting_or_data_entry_error: 'This password or private key was entered incorrectly.  There is probably a handwriting or data-entry error.  Hint: A password or private key generated by Steemit will never contain 0 (zero), O (capital o), I (capital i) and l (lower case L) characters.',
  // Settings.jsx

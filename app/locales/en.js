...
const en = {
    ...
    if_you_enjoyed_what_you_read_earn_amount: "If you enjoyed what you read here, earn {amount} of " +
        VESTING_TOKEN,
    when_you: "when you",
    ...
    membership_invitation_only: "Membership to " + APP_URL +
        " is now under invitation only because of unexpectedly high sign up rate.",
    ...
    we_require_social_account: APP_NAME +
        " funds each account with over {signup_bonus} worth of " +
        VESTING_TOKEN +
        "; to prevent abuse, we require new users to login via social media.",
    ...
    by_verifying_you_agree: "By verifying your account you agree to the " +
        APP_NAME,
    ...
    and: "and",
    are_well_tested_and_known_to_work_with: "are well tested and known to work with " +
        APP_URL +
        ".",
    ...
    get_sp_when_sign_up: "Get {signupBonus} of " + VESTING_TOKEN +
    ...
    transfer_amount_VESTING_TOKEN_to: "Transfer {amount} " + VESTING_TOKEN +
        " to",
    recieve_amount_VESTING_TOKEN_from: "Receive {amount} " + VESTING_TOKEN +
        " from",
    transfer_amount_VESTING_TOKEN_from_to: "Transfer {amount} " +
        VESTING_TOKEN +
        " from {from} to",
    ...
    curation_reward_of_VESTING_TOKEN_for: "Curation reward of {reward} " +
        VESTING_TOKEN +
        " for",
    author_reward_of_VESTING_TOKEN_for: "Author reward of {payout} and {reward} " +
        VESTING_TOKEN +
        " for",
    ...
    the_rules_of_APP_NAME: "The first rule of " + APP_NAME +
        " is: Do not lose your password.<br /> The second rule of " +
        APP_NAME +
        " is: Do <strong>not</strong> lose your password.<br /> The third rule of " +
        APP_NAME +
        " is: We cannot recover your password.<br /> The fourth rule: If you can remember the password, it&apos;s not secure.<br /> The fifth rule: Use only randomly-generated passwords.<br /> The sixth rule: Do not tell anyone your password.<br /> The seventh rule: Always back up your password.",
    ...
    understand_that_APP_NAME_cannot_recover_password: "I understand that " +
        APP_NAME +
    ...
    DEBT_TOKEN_will_be_unavailable: "This action will take place 3.5 days from now and can not be canceled. These " +
        DEBT_TOKEN +
        " will immediately become unavailable",
    amount: "Amount",
    convert: "Convert",
    invalid_amount: "Invalid amount",
    insufficent_balance: "Insufficient balance",
    in_week_convert_DEBT_TOKEN_to_LIQUID_TOKEN: "In 3.5 days, convert {amount} " +
        DEBT_TOKEN +
        " into " +
        LIQUID_TOKEN,
    ...
    recover_account_intro: "From time to time, a Steemian’s owner key may be compromised. Stolen Account Recovery gives the rightful account owner 30 days to recover their account from the moment the thief changed their owner key. Stolen Account Recovery can only be used on " +
        APP_URL +
        " if the account owner had perviously listed ‘" +
        APP_NAME +
        "’ as their account trustee and complied with " +
        APP_NAME +
        "’s Terms of Service.",
    ...
    thanks_for_submitting_request_for_account_recovery: "<p>Thanks for submitting your request for Account Recovery using " +
        APP_NAME +
        "’s blockchain-based multi factor authentication.</p> <p>We will respond to you as quickly as possible, however, please expect there may be some delay in response due to high volume of emails.</p> <p>Please be prepared to verify your identity.</p> <p>Regards,</p> <p>Ned Scott</p> <p>CEO Steemit</p>",
    ...
    we_will_be_unable_to_create_account_with_this_browser: "We will be unable to create your " +
        APP_NAME +
    ...
    APP_NAME_can_only_register_one_account_per_verified_user: "Please note that " +
        APP_NAME +
        " can only register one account per verified user",
    username: "Username",
    ...
    our_records_indicate_you_already_have_account: "Our records indicate that you already have " +
        APP_NAME +
        " account",
    to_prevent_abuse_APP_NAME_can_only_register_one_account_per_user: "In order to prevent abuse (each registered account costs {amount} in " +
        LIQUID_TOKEN +
        ") " +
        APP_NAME +
        " can only register one account per verified user.",
    ...
    your_existing_DEBT_TOKEN_are_liquid_and_transferable: "Your existing " +
        DEBT_TOKEN +
        " are liquid and transferable. Instead you may wish to trade " +
        DEBT_TOKEN +
        " directly in this site under {link} or transfer to an external market.",
    ...
    APP_NAME_cannot_recover_passwords_keep_this_page_in_a_secure_location: APP_NAME +
        " cannot recover passwords. Keep this page in a secure location, such as a fireproof safe or safety deposit box.",
    ...
    thank_you_for_being_an_early_visitor_to_APP_NAME: "Thank you for being an early visitor to " +
        APP_NAME +
        ". We will get back to you at the earliest possible opportunity.",
    ...
    buy_LIQUID_TOKEN_or_VESTING_TOKEN: "Buy " + LIQUID_TOKEN + " or " +
        VESTING_TOKEN,
    version: "Version",
    ...
    APP_NAME_is_a_social_media_platform_where_everyone_gets_paid_for_creating_and_curating_content: APP_NAME +
        " is a social media platform where <strong>everyone</strong>&nbsp;gets <strong>paid</strong> for creating and curating content",
    APP_NAME_is_a_social_media_platform_where_everyone_gets_paid: APP_NAME +
        " is a social media platform where everyone gets paid for creating and curating content. It leverages a robust digital points system, called " +
        LIQUID_TOKEN +
    ...
    tokens_worth_about_AMOUNT_of_LIQUID_TOKEN: "Tokens worth about {amount} of " +
        LIQUID_TOKEN +
        ".",
    ...
    the_estimated_value_is_based_on_an_average_value_of_steem_in_US_dollars: "The estimated value is based on an average value of " +
        LIQUID_TOKEN +
        " in US dollars.",
    VESTING_TOKEN_is_non_transferrable_and_requires_convert_back_to_LIQUID_TOKEN: VESTING_TOKEN +
        " is non-transferrable and requires 3 months (13 payments) to convert back to " +
        LIQUID_TOKEN +
        ".",
    converted_VESTING_TOKEN_can_be_sent_to_yourself_but_can_not_transfer_again: "Converted " +
        VESTING_TOKEN +
        " can be sent to yourself or someone else but can not transfer again without converting back to " +
        LIQUID_TOKEN +
        ".",
    profile: "Profile",
    ...
    spend_your_DEBT_TOKEN_to_advertise_this_post: "Spend your " + DEBT_TOKEN +
        "s to advertise this post in the promoted content section",
    you_successfully_promoted_this_post: "You successfully promoted this post",
    leave_this_unchecked_to_receive_half_your_reward: "Leave this unchecked to receive 1/2 your reward in " +
        VESTING_TOKEN +
        " and 1/2 in " +
        DEBT_TOKEN,
    ...
    by_verifying_you_agree_with_privacy_policy_of_website_APP_URL: "of " +
        APP_URL,

const es_AR = 	{
	...
	DEBT_TOKEN_conversions_have_risk: 'Steem Dollar conversions have risk. There is no guarantee on the amount of STEEM that will result from the conversion. The conversion amount depends on many factors including fluxuating market prices, witness price feeds, and witness price feed biases',
    amount: 'Cantidad',

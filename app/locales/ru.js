...
const ru = {
	...
	membership_invitation_only: 'Членство в ' + APP_URL + ' сейчас работает только по приглашению из-за слишком большого количества регистрируемых пользователей.',
  ...
  transfer_amount_steem_power_to: "Перевод {amount} "+OWNERSHIP_TICKER+" в Силу Голоса",
	...
	the_estimated_value_is_based_on_a_7_day_average_value_of_OWNERSHIP_TOKEN_in_currency: 'Оценочная стоимость расчитывается из 7ми дневной средней стоимости ' + OWNERSHIP_TOKEN + ' в российских рублях.',

...
const ru = {
	...
	buy: 'Купить',
	sell: 'Продать',
	buy_steem_power: 'Купить Steem Power', // Golos Power?
	...
	authors_get_paid_when_people_like_you_upvote_their_post: 'Авторы получают вознаграждение, когда люди голосуют за их посты',
	if_you_enjoyed_what_you_read_earn_amount: "Если вам понравилось, то что вы прочитали, заработайте {amount} в " + INVEST_TOKEN,
	when_you: "когда вы",
	when_you_link_text: 'зарегистрируетесь',
	and_vote_for_it: 'и проголосуете за него',
	// post_promo_text: "Авторы получают вознаграждение, когда люди голосуют за их посты<br />Если вам понравилось, то что вы нашли здесь, заработайте {amount} в " + INVEST_TOKEN + "<br /> когда вы {link} и проголосуете за это.",
	post_promo_text_link: '',
	read_only_mode: 'Из-за технического обслуживания сервера мы работаем в режиме чтения. Извините за неудобства.',
	membership_invitation_only: 'Членство в Steemit.com сейчас возможно только по приглашению из-за слишком большого количества регистрирущихся пользователей.', // желающих зарегистрироваться ?
	submit_email_to_get_on_waiting_list: 'Добавьте ваш адрес электронной почты чтобы попасть в список ожидания',
	login: 'Войти',
	logout: 'Выйти',
	show_less_low_value_posts: "Показать меньше сообщений низкой стоимости", // подумать
	show_more_low_value_posts: "Показать больше сообщений низкой стоимости",
	select_topic: 'Выбрать тему', // статью? 
	tags_and_topics: "Тэги и темы",
	filter: "Фильтр",
	show_more_topics: "Показать больше тем",
	we_require_social_account: APP_NAME + ' спонсирует каждый аккаунт на сумму около {signup_bonus} в ' + INVEST_TOKEN + '; чтобы предотвратить злоупотребление, мы просим новых пользователей регистрироваться через социальные сети.',
	...
	requires_positive_karma: 'необходима позитивная карма комментирования на Reddit',
	...
	by_verifying_you_agree: 'Зарегистрировав ваш аккаунт вы соглашаетесь с Steemit',
	by_verifying_you_agree_terms_and_conditions: 'условиями и положениями',
	...
	popular: 'популярное', //???
	/* end dropdown menu */
	loading: 'Загрузка', // Загружаемся? Загружается?
	...
	latest_browsers_do_work: 'Последние версии {chromeLink} и {mozillaLink} хорошо тестированы и работают с steemit.com.', // подумать
	...
	get_INVEST_TOKEN_when_sign_up: 'Получи {signupBonus} ' + INVEST_TOKEN + ' зарегистрировавшись сегодня.',
	...
	tag_your_story: 'Добавь тэги (до 5 штук), первый тэг станет основным.',
	...
	start_power_down_of: "Началось снижение голоса с",
	...
	recover_account_intro: "Иногда бывает что  ключ владельца может быть скомпрометирован. Восстановление украденного аккаунта дает законному владельцу 30 дней чтобы вернуть аккаунт с момента изменения главного ключа мошенником. Восстановление украденного аккаунта в " + APP_URL + " возможно только если владелец аккаунта ранее указал '" + APP_NAME + "' в качестве доверенного лица и согласился с Условиями Использования сайта  " + APP_NAME + ".",

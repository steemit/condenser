...
const ru = {
	...
	we_require_social_account: APP_NAME + ' спонсирует каждый аккаунт на сумму около {signup_bonus} в ' + VESTING_TOKEN2 + '; чтобы предотвратить злоупотребление, мы просим новых пользователей регистрироваться используя социальные сети.',
	...
	get_sp_when_sign_up: 'Получи {signupBonus} ' + VESTING_TOKENS + ' подписавшись сегодня.',
	...
	next_power_down_is_scheduled_to_happen_at: 'Следующее понижение ' + VESTING_TOKENS + ' запланировано на',

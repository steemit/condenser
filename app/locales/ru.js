...
const ru = {
	...
	change_account_password: 'Сменить пароль',
	...
	replies: 'Ответы',
	payouts: 'Выплаты',
    tag_tbl: 'Ключевое слово',
    replies_tbl: 'Количество комментариев',
    payouts_tbl: 'Сумма выплат',
	...
	influence_tokens_which_earn_more_power_by_holding_long_term_transfer: 'Сила Голоса неперемещаемая, количество токенов ' + VESTING_TOKEN_CASE('ы') +', увеличивается при долгосрочном хранении.',
	...
	VESTING_TOKEN_is_non_transferrable_and_will_require_2_years_and_104_payments_to_convert_back_to_LIQUID_TOKEN_transfer: VESTING_TOKEN_CASE('у') + ' нельзя передать другому аккаунты, потребуется 2 года или 104, равных выплаты чтобы конвертировать её обратно в ' + LIQUID_TOKEN + '.',
	// TODO

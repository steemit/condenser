...
const ru = {
	...
	read_only_mode: 'Из-за технического обслуживания сервера мы работает в режиме чтения. Извините за неудобства.',
	membership_invitation_only: 'Членство в Steemit.com сейчас работает только по приглашению из-за слишком большого количества регистрирущихся пользователей.', // желающих зарегистрироваться ?

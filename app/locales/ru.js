...
const ru = {
	...
	clear_sure: 'Are you sure you want to clear this form?',
	only_images: 'Please insert only image files.',
	uploading: 'Uploading...',
	markdown: 'Markdown',
	draft_saved: 'Draft saved.',
	insert_image_1: 'Insert images by dragging & dropping,',
	insert_image_2: 'pasting from the clipboard, or by ',
	insert_image_3: 'selecting them',
	image_upload: 'Image upload:',
	reward_all_power: 'Power Up 100%',
	reward_fifty_fifty: 'Default (50% / 50%)',
	reward_decline: 'Decline Payout',
	markdown_guide: 'Markdown Styling Guide',
	// this is mainly used in CategorySelector
	maximum_tag_length_is_24_characters: 'Максимальная длина категории 24 знака',
	use_limited_amount_of_categories: 'Пожалуйста используйте не более {amount} категорий',
	...
	request_already_submitted_contact_support: 'Ваш запрос был отправлен, и мы работаем над этим. Пожалуйста, свяжитесь с contact@steemit.com для получения статуса вашего запроса.',
	...
	post_as: 'Запостить как {username}', // 'Post as Misha'
	action: 'Действие',

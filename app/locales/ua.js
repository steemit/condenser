...
export const ua = {
	...
	password_is_bound_to_your_accounts_owner_key: "Цей пароль прив'язаний до головного ключу аккаунта і не може бути використаний для авторизації на сайті",
  ...
  transfer_amount_steem_power_to: "Переклад {amount} " + OWNERSHIP_TICKER + " в Силу Голосу",
	...
	account_recovery_request_not_confirmed: "Запит відновлення аккаунта ще не підтверджений, будь ласка перевірте пізніше. Дякуємо за ваше терпіння.",
	...
	the_owner_key_is_required_to_change_other_keys: 'Ключ власника це головний ключ до всього аккаунта, він необхідний для зміни інших ключів.',
	...
	sorry_your_reddit_account_doesnt_have_enough_karma: "Вибачте, у вашого Reddit аккаунта недостатньо Reddit карми щоб мати можливість безкоштовної реєстрації. Будь ласка, додайте вашу електронну пошту щоб записатися в лист очікування",

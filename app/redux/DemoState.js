    ...
    user: {
        current: {
            ...
            wallet: {
                ...
                encrypted_keys: { $pubkey: "encryptedprivkey" }
            }
        },
        users: {
            alice: {
    ...
    discussions: {
        update_status: {
            ...
            trending: {
                ...
                fetching: false,
                timeout: new Date(),
                /// fetching from start, else author/slug
                fetch_cursor: null
            },
            recent: {},
            expiring: {},
        ...
        category: {
            "~trending": [ "cat1", "cat2" ],
            /// used to track trending categories
            "~best": [ "bestcat1", "bestcat2" ],
            /// used to track all time best categories
            "~active": [],
            general: {
                trending: [ "author/slug", "author3/slug" ],
        ...
        "author/slug": {
            ...
            replies: [],
            /// there is data to be fetched if 'children' is not 0

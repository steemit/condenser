    ...
    transformations: [
        ...
        },
        {
            ...
            reducer: (state, {payload: {data, order, category, author, accountname, /*permlink*/}}) => {
                ...
                let new_state;
                if (order === 'by_author' || order === 'by_resteemed' || order === 'by_feed' || order === 'by_comments' || order === 'by_replies') {
                    // category is either "blog", "resteemed", "feed", "comments", or "recent_replies" (respectively) -- and all posts are keyed under current profile

...
function addSiteMeta(metas) {
    ...
    metas.push({property: 'og:image', content: 'https://staging.golos.io/images/golos-share.png'});
    ...
    metas.push({name: 'twitter:image', content: 'https://staging.golos.io/images/golos-share.png'});
}
...
export default function extractMeta(chain_data, rp) {
    ...
    if (rp.username && rp.slug) { // post
        ...
        if (content) {
            ...
            const url = 'https://staging.golos.io' + d.link;
            const title = d.title + ' — Голос';
            const image = d.image_link ? d.image_link : 'https://staging.golos.io/images/golos-share.png';
            const twimage = d.image_link ? d.image_link : 'https://staging.golos.io/images/golos-twshare.png';
            metas.push({title});

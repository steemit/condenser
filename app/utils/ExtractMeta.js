...
function addSiteMeta(metas) {
    ...
    metas.push({
        property: "og:image",
        content: "https://steemit.com/images/steemit-share.png"
    });
...
export default function extractMeta(chain_data, rp) {
    ...
    if (rp.username && rp.slug) {
        ...
        if (content && content.id !== "0.0.0") {
            ...
            metas.push({
                property: "og:image",
                content: image || "https://steemit.com/images/steemit-share.png"
            });
            ...
            metas.push({
                name: "twitter:image",
                content: image ||
                    "https://steemit.com/images/steemit-twshare.png"
            });
        } else {
            addSiteMeta(metas);
        }

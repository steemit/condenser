...
export default class Iframe extends React.Component {
    ...
    renderFrame = () => {
        ...
        return <iframe type="text/html" width="640" height="360" src={
            src
    ...
    renderInput = () => {
        ...
        return <input value={src} onChange={this.onChange} onClick={
            this.onClick
        } placeholder="Enter a YouTube or Vimeo URL..." style={style} />;
    };
}
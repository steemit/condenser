...
export default connect(
    ...
    class Image extends React.Component {
        ...
        render() {
            ...
            if (!src)
                return <small className="info">Loading Image…</small>;

            if (/^https?:\/\//.test(src))
                return <img {...attributes} src={prefix + src} alt={
                    alt
                } className={className} />;
            ...
            if (uploading)
                return (
                    <div {...attributes}>
                        {img}
                        <br />
                        <small className="info">Uploading Image…</small>
                    </div>
                );

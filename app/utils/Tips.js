...
export const steemTip = translate(
    "tradeable_tokens_that_may_be_transferred_anywhere_at_anytime"
) +
    " " +
    translate(
        "LIQUID_TOKEN_can_be_converted_to_VESTING_TOKEN_in_a_process_called_powering_up"
    );
...
export const valueTip = translate(
    "the_estimated_value_is_based_on_an_average_value_of_steem_in_US_dollars"
);
export const powerTip2 = translate(
    "VESTING_TOKEN_is_non_transferrable_and_requires_convert_back_to_LIQUID_TOKEN"
);
export const powerTip3 = translate(

    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface
            .createTable("accounts", {
                ...
                owner_key: { type: Sequelize.STRING },
                active_key: { type: Sequelize.STRING },
                posting_key: { type: Sequelize.STRING },
                memo_key: { type: Sequelize.STRING },
                referrer: { type: Sequelize.STRING },
                refcode: { type: Sequelize.STRING },
                remote_ip: { type: Sequelize.STRING },
                ignored: {

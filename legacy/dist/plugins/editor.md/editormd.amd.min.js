        ...
        if (define.amd) {
            var t = 'codemirror/mode/',
                ...
                o = [
                    ...
                    t + 'erlang/erlang',
                    t + 'jade/jade',
                    i + 'edit/trailingspace',
                    i + 'dialog/dialog',
                    i + 'search/searchcursor',
                    i + 'search/search',
                    i + 'scroll/annotatescrollbar',
                    i + 'search/matchesonscrollbar',
                    i + 'display/placeholder',
                    i + 'edit/closetag',
                    i + 'fold/foldcode',
                    i + 'fold/foldgutter',
                    i + 'fold/indent-fold',
                    i + 'fold/brace-fold',
                    i + 'fold/xml-fold',
                    i + 'fold/markdown-fold',
                    i + 'fold/comment-fold',
                    i + 'mode/overlay',
                    i + 'selection/active-line',
                    i + 'edit/closebrackets',
                    i + 'display/fullscreen',
                    i + 'search/match-highlighter',
                ];
            define(o, e);
        ...
        (t.prototype = t.fn = {
            ...
            init: function(i, o) {
                ...
                l.length < 1 &&
                    ...
                    l
                        .addClass(s.textarea.markdown)
                        .attr('placeholder', n.placeholder),
                    ('undefined' == typeof l.attr('name') ||
                        '' === l.attr('name')) &&
                        l.attr(
                            'name',
                            '' !== n.name ? n.name : i + '-markdown-doc'
                        );
                var c = [
                    n.readOnly
                        ? ''
                ...
                return (
                    ...
                    (this.containerMask = a.children(
                        '.' + r + 'container-mask'
                    )),
                    '' !== n.markdown && l.val(n.markdown),
                    '' !== n.appendMarkdown &&
                        l.val(l.val() + n.appendMarkdown),
                    ...
                    '' !== n.previewTheme &&
                        this.preview.addClass(
                            r + 'preview-theme-' + n.previewTheme
                        ),
                    'function' == typeof define &&
                        define.amd &&
                        ...
                        n.searchReplace &&
                            !n.readOnly &&
                            (t.loadCSS(
                                n.path + 'codemirror/addon/dialog/dialog'
                            ),
                            t.loadCSS(
                                n.path +
            ...
            loadQueues: function() {
                ...
                return (
                    ...
                    i.codeFold &&
                        t.loadCSS(o + 'codemirror/addon/fold/foldgutter'),
                    t.loadScript(o + 'codemirror/codemirror.min', function() {
                        (t.$CodeMirror = CodeMirror),
                            t.loadScript(
                                o + 'codemirror/modes.min',
                                function() {
                                    t.loadScript(
                                        o + 'codemirror/addons.min',
                                        function() {
                                            return (
                                                e.setCodeMirror(),
                                                'gfm' !== i.mode &&
            ...
            setCodeMirror: function() {
                ...
                var o = {
                    ...
                    highlightSelectionMatches: e.matchWordHighlight
                        ? {
                              showToken:
                                  'onselected' === e.matchWordHighlight
                                      ? !1
                                      : /\w/,
                          }
                        : !1,
                ...
                return (
                    (this.codeEditor = this.cm = t.$CodeMirror.fromTextArea(
                        this.markdownTextarea[0],
                        o
                    )),
                    (this.codeMirror = this.cmElement = i.children(
                        '.CodeMirror'
                    )),
            ...
            setToolbar: function() {
                ...
                return (
                    ...
                    s
                        .find('[title="ucwords"]')
                        .attr('title', e.lang.toolbar.ucwords),
            ...
            getToolbarHandles: function(e) {
                ...
                return e && 'undefined' != typeof toolbarIconHandlers[e]
                    ? i[e]
                    : i;
            },
                        ...
                        return '' !== a
                            ? ((i.activeIcon = r),
                              'undefined' != typeof l[a]
                                  ? e.proxy(l[a], i)(n)
                                  : 'undefined' !=
                                        typeof o.toolbarHandlers[a] &&
                                    e.proxy(o.toolbarHandlers[a], i)(
                                        n,
                                        r,
                                        s,
                                        c
            ...
            bindScrollEvent: function() {
                ...
                var s = function() {
                        n
                            ...
                            .bind(a('scroll', 'touchmove'), function(t) {
                                var n = e(this).height(),
                                    a = e(this).scrollTop(),
                ...
                if (
                    ...
                    if ((c.html(g), this.previewCodeHighlight(), a.toc)) {
                        ...
                        p.attr(
                            ...
                            (a.tocDropdown ||
                                p.find('.' + this.classPrefix + 'toc-menu')
                                    .length > 0) &&
                                t.tocDropdownMenu(
                                    p,
                                    '' !== a.tocTitle
        ...
        return (
                ...
                return (
                    (l.emoji = function(e) {
                        ...
                        for (var o = 0, r = i.length; r > o; o++)
                            ':+1:' === i[o] && (i[o] = ':\\+1:'),
                                (e = e.replace(new RegExp(i[o]), function(
                                    e,
                                    i
                                ) {
                                    var o = e.match(p),
                    ...
                    (l.heading = function(e, t, o) {
                        ...
                        return (
                            (g +=
                                '<a name="' +
                                e +
                                '" class="reference-link"></a>'),
                            (g +=
                                '<span class="header-link octicon octicon-link"></span>'),
                            (g += this.atLink(
                                a ? this.emoji(n) : this.emoji(e)
                            )),
                            (g += '</h' + t + '>')
                        );
                    }),
                            ...
                            : 'flow' === i
                              ...
                              : 'math' === i || 'latex' === i || 'katex' === i
                                ? '<p class="' +
                                  ...
                                  e +
                                  '</p>'
                                : s.Renderer.prototype.code.apply(
                                      this,
                                      arguments
                                  );
                    }),
            ...
            (t.markdownToHTML = function(i, o) {
                ...
                if (
                    ...
                    a.toc &&
                        ...
                        (a.tocDropdown ||
                            n.find('.' + this.classPrefix + 'toc-menu').length >
                                0) &&
                            this.tocDropdownMenu(n, a.tocTitle),
                        '' !== a.tocContainer &&
                            n
                                .find(
                                    '.editormd-toc-menu, .editormd-markdown-toc'
                                )
                                .remove()),
                    a.previewCodeHighlight &&
                        (n.find('pre').addClass('prettyprint linenums'),
                        prettyPrint()),
                    t.isIE8 ||
            ...
            (t.createDialog = function(i) {
                ...
                '' !== i.title &&
                    ...
                    i.closed &&
                        (h +=
                            ...
                            'dialog-close"></a>'),
                    (h +=
                        '<div class="' + a + 'dialog-container">' + i.content),
                ...
                if ('' !== i.title && i.drag) {
                    ...
                    var b = function(e) {
                            e
                                .removeClass(a + 'user-unselect')
                                .off('selectstart');
                        },
                        x = function(e) {
                            e
                                .addClass(a + 'user-unselect')
                            ...
                            var t = null,
                                ...
                                o = function(i) {
                                    ...
                                    e(this)
                                        ...
                                        .css({
                                            top:
                                                o.changedTouches[0].pageY - t.y,
                                            left:
                                                o.changedTouches[0].pageX - t.x,
                                        });
                                };

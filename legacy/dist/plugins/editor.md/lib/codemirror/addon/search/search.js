...
(function(mod) {
    ...
    function doSearch(cm, rev) {
        ...
        dialog(cm, queryDialog, 'Search for:', cm.getSelection(), function(
            query
        ) {
    ...
    function replace(cm, all) {
        ...
        dialog(cm, replaceQueryDialog, 'Replace:', cm.getSelection(), function(
            query
        ) {
            if (!query) return;
            query = parseQuery(query);
            dialog(cm, replacementQueryDialog, 'Replace with:', '', function(
                text
            ) {
                if (all) {
                    cm.operation(function() {

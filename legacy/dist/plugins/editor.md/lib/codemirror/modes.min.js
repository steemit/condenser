...
!(function(e) {
    ...
    (function(e) {
        ...
        e.defineMode('css', function(t, r) {
            ...
            function l(e, t, r) {
                return (
                    (e.context = new s(r, t.indentation() + p, e.context)), r
                );
            }
            function c(e) {
            ...
            function f(e) {
                ...
                h = S.hasOwnProperty(t)
                    ? 'atom'
                    : C.hasOwnProperty(t) ? 'keyword' : 'variable';
            }
    ...
    (function(e) {
        ...
        e.defineMode('sass', function(e) {
            ...
            function l(e, t) {
                ...
                if (e.match('/*'))
                    return (
                        (t.tokenizer = n(e.indentation(), !0)),
                        t.tokenizer(e, t)
                    );
                if (e.match('//'))
                    return (
                        (t.tokenizer = n(e.indentation(), !1)),
                        t.tokenizer(e, t)
                    );
                if (e.match('#{')) return (t.tokenizer = o(l)), 'operator';
                if ('"' === c || "'" === c)
                    return e.next(), (t.tokenizer = i(c)), 'string';
                if (t.cursorHalf) {
                    if (
                        '#' === c &&
                    ...
                    if (e.match(/^(px|em|in)\b/))
                        return e.peek() || (t.cursorHalf = 0), 'unit';
                    if (e.match(d))
                        return e.peek() || (t.cursorHalf = 0), 'keyword';
                    ...
                    if (e.match(m))
                        return e.peek() || (t.cursorHalf = 0), 'operator';
                    if (e.eatWhile(/[\w-]/))
                        return e.peek() || (t.cursorHalf = 0), 'attribute';
            ...
            return {
                ...
                token: function(e, t) {
                    var r = c(e, t);
                    return (
                        (t.lastToken = { style: r, content: e.current() }), r
                    );
                },
                indent: function(e) {
    ...
    (function(e) {
        ...
        e.defineMode('shell', function() {
            ...
            function t(e, t) {
                ...
                if ("'" === s || '"' === s || '`' === s)
                    return t.tokens.unshift(r(s)), n(e, t);
                if ('#' === s)
                    return a && e.eat('!')
                        ? (e.skipToEnd(), 'meta')
                        : (e.skipToEnd(), 'comment');
    ...
    (function(e) {
        ...
        e.defineMode('sql', function(t, r) {
            function n(e, t) {
                ...
                if (m.commentSlashSlash && '/' == r && e.eat('/'))
                    return e.skipToEnd(), 'comment';
                if (
                    (m.commentHash && '#' == r) ||
                    ('-' == r &&
                        e.eat('-') &&
                        (!m.commentSpaceRequired || e.eat(' ')))
                )
                    return e.skipToEnd(), 'comment';
                if ('/' == r && e.eat('*'))
                    ...
                    return p.hasOwnProperty(a) &&
                        ...
                        : c.hasOwnProperty(a)
                          ...
                          : u.hasOwnProperty(a)
                            ...
                            : d.hasOwnProperty(a)
                              ? 'keyword'
                              : l.hasOwnProperty(a) ? 'string-2' : null;
                }
                return 1 == m.zerolessFloat &&
                    e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)
                    ? 'number'
            ...
            (function() {
                ...
                function n(e) {
                    return e.eat('N')
                        ? 'atom'
                        : e.match(/^[a-zA-Z.#!?]/) ? 'variable-2' : null;
                }
                function i(e) {
        ...
        e.defineMode('clike', function(t, r) {
            function n(e, t) {
                ...
                return m.propertyIsEnumerable(a)
                    ? (p.propertyIsEnumerable(a) && (c = 'newstatement'),
                      'keyword')
                    : h.propertyIsEnumerable(a)
                      ? (p.propertyIsEnumerable(a) && (c = 'newstatement'),
                        'builtin')
                      : g.propertyIsEnumerable(a) ? 'atom' : 'variable';
            }
            function i(e) {
                return function(t, r) {
            ...
            return 0 == e.length
                ...
                : function(i, o) {
                      for (var a = e[0], s = 0; s < a.length; s++)
                          if (i.match(a[s][0]))
                              return (o.tokenize = r(e.slice(1), t)), a[s][1];
        ...
        e.defineMode(
            ...
            function(t, r) {
                function n(e, t) {
                    ...
                    if (e.match(/^<\?\w*/))
                        return (t.curMode = o), (t.curState = t.php), 'meta';
    ...
    (function(e) {
        ...
        e.defineMode('xml', function(t, r) {
            ...
            function g(e, t, r) {
                ...
                if ('endTag' == e || 'selfcloseTag' == e) {
                    ...
                    return (
                        ...
                        'selfcloseTag' == e ||
                        S.autoSelfClosers.hasOwnProperty(n)
                            ? u(r, n)
                            : (u(r, n),
                              (r.context = new l(r, n, i == r.indented))),
                        d
                    );
                }
                return (C = 'error'), g;
            ...
            function v(e, t, r) {
                return 'equals' == e
                    ? b
                    : (S.allowMissing || (C = 'error'), g(e, t, r));
            }
            function b(e, t, r) {
                return 'string' == e
                    ? y
                ...
                indent: function(t, r, o) {
                    ...
                    if (s && s[1])
                        for (; a; ) {
                            ...
                            if (!S.implicitlyClosed.hasOwnProperty(a.tagName))
                                break;
                            a = a.prev;
                        }
                    else if (s)
            ...
            function(t, r) {
                ...
                function s(e, t) {
                    ...
                    if (t.indentationDiff >= 4)
                        return (t.indentation -= 4), e.skipToEnd(), S;
                    if (e.eatSpace()) return null;
                    if ((s = e.match(U)))
                        return (
                    ...
                    if (
                        (!t.prevLineHasContent || a) &&
                        (e.match(H, !1) || e.match(N, !1))
                    ) {
                        var l = null;
                        return (
                            e.match(H, !0)
                            ...
                            r.highlightFormatting &&
                                (t.formatting = ['list', 'list-' + l]),
                            d(t)
                        );
                    }
                    return r.fencedCodeBlocks &&
                        e.match(/^```[ \t]*([\w+#]*)/, !0)
                        ? ((t.localMode = n(RegExp.$1)),
                          t.localMode &&
                              (t.localState = t.localMode.startState()),
                          (t.f = t.block = c),
                          r.highlightFormatting &&
                ...
                function d(e) {
                        ...
                        for (var n = 0; n < e.formatting.length; n++)
                            t.push(z + '-' + e.formatting[n]),
                                ...
                                'quote' === e.formatting[n] &&
                                    t.push(
                                        !r.maxBlockquoteDepth ||
                                        r.maxBlockquoteDepth >= e.quote
                                            ? z +
                                              '-' +
                                              e.formatting[n] +
                                              '-' +
                    ...
                    if (e.taskClosed)
                        return (
                            t.push('property'), t.length ? t.join(' ') : null
                        );
                    if (e.linkHref)
                        return t.push(A), t.length ? t.join(' ') : null;
                    if (
                        (e.strong && t.push(O),
                        e.em && t.push($),
                ...
                function m(t, n) {
                    ...
                    if (
                        ...
                        return (
                            r.highlightFormatting && (n.formatting = 'header'),
                            d(n)
                        );
                    var s = t.sol(),
                        c = t.next();
                ...
                function g(e) {
                    return function(t, n) {
                        ...
                        if (i === e) {
                            (n.f = n.inline = m),
                                r.highlightFormatting &&
                                    (n.formatting = 'link-string');
                            var o = d(n);
                            return (n.linkHref = !1), o;
                        }
                        return (
                            t.match(x(e), !0) && t.backUp(1),
                            (n.linkHref = !0),
                            d(n)
                        );
                    };
                ...
                var k = e.modes.hasOwnProperty('xml'),
                    w = e.getMode(
                        t,
                        k ? { name: 'xml', htmlMode: !0 } : 'text/plain'
                    );
                void 0 === r.highlightFormatting &&
                    (r.highlightFormatting = !1),
                    void 0 === r.maxBlockquoteDepth &&
                        (r.maxBlockquoteDepth = 0),
                    void 0 === r.underscoresBreakWords &&
                        (r.underscoresBreakWords = !0),
                    ...
                    Z = {
                        ...
                        copyState: function(t) {
                            return {
                                ...
                                block: t.block,
                                htmlState:
                                    t.htmlState && e.copyState(w, t.htmlState),
    ...
    (function(e) {
        ...
        e.defineMode('javascript', function(t, r) {
            ...
            function o(e, t) {
                var r = e.next();
                if ('"' == r || "'" == r)
                    return (t.tokenize = a(r)), t.tokenize(e, t);
                if ('.' == r && e.match(/^\d+(?:[eE][+\-]?\d+)?/))
            ...
            function f(e, t, r, n, i) {
                ...
                for (
                    ...
                    if (a(r, n)) {
                        ...
                        return Le.marked
                            ? Le.marked
                            : 'variable' == r && d(e, n) ? 'variable-2' : t;
                    }
                }
            }
            function m() {
                for (var e = arguments.length - 1; e >= 0; e--)
                    Le.cc.push(arguments[e]);
            }
            function h() {
            ...
            function p(e) {
                ...
                if (n.context) {
                    ...
                    r.globalVars &&
                        (n.globalVars = { name: e, next: n.globalVars });
                }
            }
            function g() {
                (Le.state.context = {
                      ...
                      : 'quasi' == e
                        ...
                        : ';' != e
                          ? '(' == e
                            ...
                            : '.' == e
                              ? h(P, n)
                              : '[' == e ? h(b(']'), S, x(']'), y, n) : void 0
                          : void 0;
            }
            function E(e, t) {
                return 'quasi' != e
                    ? m()
                    : '${' != t.slice(t.length - 2) ? h(E) : h(w, q);
            }
            function q(e) {
                return '}' == e
            ...
            function D(e, t) {
                return 'variable' == e || 'keyword' == Le.style
                    ? ((Le.marked = 'property'),
                      h('get' == t || 'set' == t ? A : $))
                    : 'number' == e || 'string' == e
                      ? ((Le.marked = ye ? 'property' : Le.style + ' property'),
                        h($))
                      : 'jsonld-keyword' == e
                        ? h($)
                        : '[' == e ? h(w, x(']'), $) : void 0;
                            ...
                            : 'form' == u && '{' == i
                              ...
                              : 'form' == u
                                ...
                                : 'stat' == u
                                  ...
                                  : 'switch' != a.info ||
                                    d ||
                                    0 == r.doubleIndentSwitch
                                    ? a.align
                                      ? a.column + (d ? 0 : 1)
                                      : a.indented + (d ? 0 : ve)
                                    : a.indented +
                                      (/^(?:case|default)\b/.test(n)
                                          ? ve
                                          : 2 * ve);
                    },
            ...
            function(t, r) {
                ...
                return (
                    c.push({ matches: /./, mode: e.getMode(t, 'text/plain') }),
                    {
                        ...
                        copyState: function(t) {
                            if (t.localState)
                                var r = e.copyState(t.localMode, t.localState);
                            return {
                                token: t.token,
                                localMode: t.localMode,
                                localState: r,
    ...
    (function(e) {
        ...
        e.defineMode('http', function() {
            ...
            function a(e) {
                return e.sol() && !e.eat(/[ \t]/)
                    ? e.match(/^.*?:/) ? 'atom' : (e.skipToEnd(), 'error')
                    : (e.skipToEnd(), 'string');
            }
            function s(e) {
    ...
    (function(e) {
        ...
        e.defineMode('go', function(e) {
            function t(e, t) {
                var i = e.next();
                if ('"' == i || "'" == i || '`' == i)
                    return (t.tokenize = r(i)), t.tokenize(e, t);
                if (/[\d\.]/.test(i))
                    return (
                        '.' == i
                            ? e.match(/^[0-9]+([eE][\-+]?[0-9]+)?/)
                            : '0' == i
                              ? e.match(/^[xX][0-9a-fA-F]+/) ||
                                e.match(/^0[0-7]+/)
                              : e.match(/^[0-9]*\.?[0-9]*([eE][\-+]?[0-9]+)?/),
                        'number'
                    );
                ...
                return c.propertyIsEnumerable(o)
                    ? (('case' == o || 'default' == o) && (s = 'case'),
                      'keyword')
                    : u.propertyIsEnumerable(o) ? 'atom' : 'variable';
            }
            function r(e) {
                return function(r, n) {
    ...
    (function(e) {
        ...
        e.defineMode('coffeescript', function(e, t) {
            ...
            function n(e, t) {
                ...
                if (e.match(b))
                    return (
                        (t.tokenize = i(e.current(), !1, 'string')),
                        t.tokenize(e, t)
                    );
                if (e.match(y)) {
                    if ('/' != e.current() || e.match(/^.*\//, !1))
                        return (
                            (t.tokenize = i(e.current(), !0, 'string-2')),
                            t.tokenize(e, t)
                        );
                    e.backUp(1);
                }
            ...
            var b = /^('{3}|\"{3}|['\"])/,
                ...
                w = {
                    ...
                    indent: function(e, t) {
                        ...
                        if (i)
                            for (; 'coffee' == r.type && r.prev; ) r = r.prev;
            ...
            return {
                ...
                indent: function(e, t) {
                    ...
                    return (
                        /^\}/.test(t) &&
                            (r -=
                                'rule' == e.stack[e.stack.length - 1] ? 2 : 1),
                        e.baseIndent + r * d
                    );
                },
                electricChars: '}',
        ...
        e.registerHelper('hintWords', 'python', i.concat(o)),
            e.defineMode('python', function(l, c) {
                ...
                function f(e) {
                    ...
                    for (; 'rub'.indexOf(e.charAt(0).toLowerCase()) >= 0; )
                        e = e.substr(1);
                    var r = 1 == e.length,
                        n = 'string';
                ...
                var _ = c.hangingIndent || l.indentUnit,
                    ...
                    S = o;
                if (
                    (void 0 != c.extra_keywords &&
                        (C = C.concat(c.extra_keywords)),
                    void 0 != c.extra_builtins &&
                        (S = S.concat(c.extra_builtins)),
    ...
    (function(e) {
        ...
        function i(e, t) {
            ...
            0 >= n
                ? (e.pos = 0)
                : n >= (r = e.string.length - 1) ? (e.pos = r) : (e.pos = n);
        }
        e.defineMode('perl', function() {
            ...
            function a(a, u) {
                ...
                if (
                    ...
                    return 'number';
                if (a.match(/^<<(?=\w)/))
                    return a.eatWhile(/\w/), o(a, u, a.current().substr(2));
                ...
                if ('q' == d) {
                    ...
                    if (!h || !/\w/.test(h))
                        if (((h = t(a, 0)), 'x' == h)) {
                            if (((h = t(a, 1)), '(' == h))
                                return i(a, 2), e(a, u, [')'], l, c);
                            if ('[' == h) return i(a, 2), e(a, u, [']'], l, c);
                            if ('{' == h) return i(a, 2), e(a, u, ['}'], l, c);
                            if ('<' == h) return i(a, 2), e(a, u, ['>'], l, c);
                            if (/[\^'"!~\/]/.test(h))
                                return i(a, 1), e(a, u, [a.eat(h)], l, c);
                        } else if ('q' == h) {
                            if (((h = t(a, 1)), '(' == h))
                                return i(a, 2), e(a, u, [')'], 'string');
                            if ('[' == h)
                                return i(a, 2), e(a, u, [']'], 'string');
                            if ('{' == h)
                                return i(a, 2), e(a, u, ['}'], 'string');
                            if ('<' == h)
                                return i(a, 2), e(a, u, ['>'], 'string');
                            if (/[\^'"!~\/]/.test(h))
                                return i(a, 1), e(a, u, [a.eat(h)], 'string');
                        } else if ('w' == h) {
                            if (((h = t(a, 1)), '(' == h))
                ...
                if ('/' == d)
                    return /~\s*$/.test(r(a)) ? e(a, u, [d], l, c) : 'operator';
                if ('$' == d) {
                    var f = a.pos;
                    if (
                        a.eatWhile(/\d/) ||
                        (a.eat('{') && a.eatWhile(/\d/) && a.eat('}'))
                    )
                        return 'variable-2';
                    a.pos = f;
                }
                ...
                if ('_' == d && 1 == a.pos) {
                    if ('_END__' == n(a, 6))
                        return e(a, u, ['\x00'], 'comment');
                    if ('_DATA__' == n(a, 7))
                        return e(a, u, ['\x00'], 'variable-2');
                    ...
                    return s.propertyIsEnumerable(i)
                        ...
                        : c.propertyIsEnumerable(i)
                          ? (u.propertyIsEnumerable(i) &&
                                ...
                                (a = 'block'),
                            'keyword')
                          : l.propertyIsEnumerable(i) ? 'builtin' : 'variable';
                }
                return '%' == r
                    ...
                    : '<' == r && e.eat('-')
                      ...
                      : '=' == r && t.ctx.argList
                        ? 'arg-is'
                        : d.test(r)
                          ? '$' == r ? 'dollar' : (e.eatWhile(d), 'operator')
                          : /[\(\){}\[\];]/.test(r)
                            ? ((a = r), ';' == r ? 'semi' : null)
                            : null;
            }
        ...
        e.defineMode('ruby', function(e) {
            ...
            function n(e, t) {
                ...
                if ('%' == i) {
                    ...
                    var g = e.eat(/[^\w\s=]/);
                    return g
                        ? (m.propertyIsEnumerable(g) && (g = m[g]),
                          r(a(g, h, p, !0), e, t))
                        : 'operator';
                }
                ...
                if ('@' == i && e.match(/^@?[a-zA-Z_\xa1-\uffff]/))
                    return (
                        e.eat('@'), e.eatWhile(/[\w\xa1-\uffff]/), 'variable-2'
                    );
                if ('$' == i)
                    return (
                        e.eat(/[a-zA-Z_]/)
                            ? e.eatWhile(/[\w]/)
                            : e.eat(/\d/) ? e.eat(/\d/) : e.next(),
                        'variable-3'
                    );
                ...
                if (
                    '|' != i ||
                    (!t.varList && '{' != t.lastTok && 'do' != t.lastTok)
                ) {
            ...
            function s(e) {
                return function(t, r) {
                    return (
                        t.match(e) ? r.tokenize.pop() : t.skipToEnd(), 'string'
                    );
                };
            }
            function l(e, t) {
            ...
            return {
                ...
                indent: function(t, r) {
                    ...
                    return (
                        o.indented +
                        (a ? 0 : e.indentUnit) +
                        (t.continuedLine ? e.indentUnit : 0)
                    );
                },
                electricChars: '}de',
                lineComment: '#',
        ...
        e.defineMode(
            ...
            function(t, r) {
                var n = /^\*\*[^\*\s](?:[^\*]*[^\*\s])?\*\*/,
                    ...
                    m = {
                        token: function(e) {
                            if (e.match(n) && e.match(/\W+|$/, !1))
                                return 'strong';
                            if (e.match(i) && e.match(/\W+|$/, !1)) return 'em';
                            if (e.match(o) && e.match(/\W+|$/, !1))
                                return 'string-2';
    ...
    (function(e) {
        ...
        e.defineMode(
            ...
            function(t) {
                ...
                t.hasOwnProperty('leftDelimiter') &&
                    (o.leftDelimiter = t.leftDelimiter),
                    t.hasOwnProperty('rightDelimiter') &&
                        (o.rightDelimiter = t.rightDelimiter);
                        ...
                        html: function(e, t) {
                            var r =
                                ...
                                t.htmlMixedState.htmlState.context.tagName
                                    ...
                                    : null;
                            return !t.inLiteral &&
                                e.match(l.htmlHasLeftDelimeter, !1) &&
                                null === r
                                ? ((t.tokenize = u.smarty),
                                  (t.localMode = i),
                                  (t.localState = i.startState(
                                      n.indent(t.htmlMixedState, '')
                                  )),
                                  c.maybeBackup(
                                      e,
                                      o.leftDelimiter,
                                      i.token(e, t.localState)
                                  ))
    ...
    (function(e) {
        ...
        e.defineMode('velocity', function() {
            ...
            function r(e, r) {
                ...
                var d = e.next();
                if ("'" == d && r.inParams)
                    return (r.lastTokenWasBuiltin = !1), t(e, r, n(d));
                if ('"' != d) {
                    if (/[\[\]{}\(\),;\.]/.test(d))
                        return (
                            '(' == d && u
                    ...
                    if ('#' == d && e.eat('*'))
                        return (r.lastTokenWasBuiltin = !1), t(e, r, i);
                    if ('#' == d && e.match(/ *\[ *\[/))
        ...
        e.defineMode('xquery', function() {
            ...
            function r(r, s) {
                ...
                if ('<' == f) {
                    ...
                    if (r.match('![CDATA', !1))
                        return (s.tokenize = c), e('tag', 'tag');
                    if (r.match('?', !1)) return t(r, s, u);
                    var y = r.eat('/');
                    r.eatSpace();
                    for (var x, w = ''; (x = r.eat(/[^\s\u00a0=<>\"\'\/?]/)); )
                        w += x;
                    return t(r, s, a(w, y));
                }
                ...
                if ('(' === f && r.eat(':'))
                    return v(s, { type: 'comment' }), t(r, s, n);
                if (g || ('"' !== f && "'" !== f)) {
                    if ('$' === f) return t(r, s, o);
                    if (':' === f && r.eat('='))
                        return e('operator', 'keyword');
                    if ('(' === f) return v(s, { type: 'paren' }), e('', null);
                    if (')' === f) return b(s), e('', null);
                    if ('[' === f)
                        return v(s, { type: 'bracket' }), e('', null);
                    if (']' === f) return b(s), e('', null);
            ...
            function i(t, n) {
                return function(o, a) {
                    ...
                    if (h(a) && o.current() == t)
                        return (
                            b(a), n && (a.tokenize = n), e('string', 'string')
                        );
                    if (
            ...
            function o(t, n) {
                ...
                return (
                    t.eatWhile(i), (n.tokenize = r), e('variable', 'variable')
                );
            }
            function a(t, n) {
                return function(i, o) {
                    return (
                        ...
                        n && i.eat('>')
                            ...
                            : (i.eat('/') ||
                                  v(o, { type: 'tag', name: t, tokenize: r }),
                              i.eat('>')
            ...
            return {
                token: function(e, r) {
                    ...
                    if (
                        ...
                        '#' == n &&
                            (0 == e.pos ||
                                /\s/.test(e.string.charAt(e.pos - 1))))
                    )
                        return e.skipToEnd(), 'comment';
                    if (e.match(/^('([^']|\\.)*'?|"([^"]|\\.)*"?)/))
                        return 'string';
    ...
    (function(e) {
        ...
        e.defineMIME('text/x-erlang', 'erlang'),
            e.defineMode('erlang', function(t) {
                function r(e, t) {
                    if (t.in_string)
                        return (t.in_string = !o(e)), u(t, e, 'string');
                    ...
                    if ('?' == r)
                        return e.eatSpace(), e.eatWhile(R), u(t, e, 'macro');
                    if ('#' == r)
                        return e.eatSpace(), e.eatWhile(R), u(t, e, 'record');
                    if ('$' == r)
                    ...
                    if (/[A-Z_Ø-ÞÀ-Ö]/.test(r))
                        return e.eatWhile(R), u(t, e, 'variable');
                ...
                function p(e, t) {
                    'comment' != t.type &&
                        'whitespace' != t.type &&
                        ((e.tokenStack = g(e.tokenStack, t)),
                        (e.tokenStack = v(e.tokenStack)));
                }
                function g(e, t) {
                    var r = e.length - 1;
                    return (
                ...
                function v(e) {
                    ...
                    if ('fun' === e[t].type && 'fun' === e[t - 1].token)
    ...
    (function(e) {
        ...
        e.defineMode('jade', function(t) {
            ...
            function f(e, t) {
                return e.match(/^extends?\b/)
                    ? ((t.restOfLine = 'string'), V)
                    : void 0;
            }
            function m(e, t) {
                return e.match(/^append\b/)
                    ? ((t.restOfLine = 'variable'), V)
                    : void 0;
            }
            function h(e, t) {
                return e.match(/^prepend\b/)
                    ? ((t.restOfLine = 'variable'), V)
                    : void 0;
            }
            function p(e, t) {
            ...
            function g(e, t) {
                return e.match(/^include\b/)
                    ? ((t.restOfLine = 'string'), V)
                    : void 0;
            }
            function v(e, t) {
                return e.match(/^include:([a-zA-Z0-9\-]+)/, !1) &&
                    e.match('include')
            ...
            function b(e, t) {
                if (t.isIncludeFiltered) {
                    var r = M(e, t);
                    return (
                        (t.isIncludeFiltered = !1), (t.restOfLine = 'string'), r
                    );
                }
            }
            function y(e, t) {
                return e.match(/^mixin\b/)
                    ? ((t.javaScriptLine = !0), V)
                    : void 0;
            }
            function x(e, t) {
            ...
            function C(e, t) {
                if (t.isEach) {
                    if (e.match(/^ in\b/))
                        return (t.javaScriptLine = !0), (t.isEach = !1), V;
            ...
            function L(e, t) {
                return e.match(/^(!?=|-)/)
                    ? ((t.javaScriptLine = !0), 'punctuation')
                    : void 0;
            }
            function E(e) {
            ...
            function H(e, t, r) {
                return e.indentation() > t.indentOf ||
                    (t.innerModeForLine && !e.sol()) ||
                    r
                    ? t.innerMode
                      ? (t.innerState ||

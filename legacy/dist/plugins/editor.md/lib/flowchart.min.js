...
!(function() {
    function a(b, c) {
        ...
        for (e in b)
            b[e] && (d[e] = 'object' == typeof d[e] ? a(d[e], b[e]) : b[e]);
        return d;
    }
    function b(a, b) {
    ...
    function c(a, b, c) {
        var d,
            e,
            f = 'M{0},{1}';
        for (d = 2, e = 2 * c.length + 2; e > d; d += 2)
            f += ' L{' + d + '},{' + (d + 1) + '}';
        var g = [b.x, b.y];
        for (d = 0, e = c.length; e > d; d++) g.push(c[d].x), g.push(c[d].y);
        var h = a.paper.path(f, g);
        h.attr('stroke', a.options['element-color']),
            h.attr('stroke-width', a.options['line-width']);
        var i = a.options.font,
            j = a.options['font-family'],
            k = a.options['font-weight'];
        return (
            i && h.attr({ font: i }),
            j && h.attr({ 'font-family': j }),
            k && h.attr({ 'font-weight': k }),
            h
        );
    }
    function d(a, b, c, d) {
        ...
        var g = 'M{0},{1}';
        for (e = 2, f = 2 * c.length + 2; f > e; e += 2)
            g += ' L{' + e + '},{' + (e + 1) + '}';
        var h = [b.x, b.y];
        ...
        if (
            (j && i.attr({ font: j }),
            k && i.attr({ 'font-family': k }),
            l && i.attr({ 'font-weight': l }),
            d)
        ) {
            var m = !1,
            ...
            m
                ? ((q =
                  ...
                  o
                      ? ((q -= n.getBBox().width / 2),
                        (r -= a.options['text-margin']))
                      : ((q += a.options['text-margin']),
                        (r -= n.getBBox().height / 2)))
                : ((q = b.x),
                  (r = b.y),
                  o
                      ? ((q += a.options['text-margin'] / 2),
                        (r -= a.options['text-margin']))
                      : ((q += a.options['text-margin'] / 2),
                        (r += a.options['text-margin']))),
                n.attr({
                ...
                j && n.attr({ font: j }),
                k && n.attr({ 'font-family': k }),
                l && n.attr({ 'font-weight': l });
        }
        return i;
    }
    ...
    function f(a, b) {
        (b = b || {}),
            (this.paper = new Raphael(a)),
            (this.options = r.defaults(b, q)),
            (this.symbols = []),
            (this.lines = []),
            (this.start = null);
    }
    function g(a, b, c) {
        (this.chart = a),
            ...
            (this.flowstate = b.flowstate || 'future'),
            (this.next_direction =
                b.next && b.direction_next ? b.direction_next : void 0),
            (this.text = this.chart.paper.text(0, 0, b.text)),
            b.key && (this.text.node.id = b.key + 't'),
        ...
        d && this.text.attr({ font: d }),
            e && this.text.attr({ 'font-family': e }),
            f && this.text.attr({ 'font-weight': f }),
            b.link && this.text.attr('href', b.link),
            b.target && this.text.attr('target', b.target);
        var g = this.getAttr('maxWidth');
        if (g) {
            for (
                var h = b.text.split(' '), i = '', j = 0, k = h.length;
                k > j;
                j++
            ) {
                var l = h[j];
                this.text.attr('text', i + ' ' + l),
                    (i += this.text.getBBox().width > g ? '\n' + l : ' ' + l);
            }
        ...
        if ((this.group.push(this.text), c)) {
            ...
            c.attr({
                ...
                c.node.setAttribute('class', this.getAttr('class')),
                b.link && c.attr('href', b.link),
                b.target && c.attr('target', b.target),
                b.key && (c.node.id = b.key),
                this.group.push(c),
                c.insertBefore(this.text),
                this.text.attr({ y: c.getBBox().height / 2 }),
                this.initialize();
        }
    }
    function h(a, b) {
    ...
    function k(a, b) {
        ...
        (b = b || {}),
            ...
            c.attr({
                width:
                    this.text.getBBox().width + 4 * this.getAttr('text-margin'),
            }),
        ...
        d.attr({
            ...
            height:
                this.text.getBBox().height + 2 * this.getAttr('text-margin'),
            fill: this.getAttr('fill'),
        }),
        ...
        e && d.attr({ font: e }),
            f && d.attr({ 'font-family': f }),
            h && d.attr({ 'font-weight': h }),
            b.link && d.attr('href', b.link),
            b.target && d.attr('target', b.target),
            this.group.push(d),
            d.insertBefore(this.text),
            this.initialize();
    }
    function l(a, b) {
        (b = b || {}),
        ...
        var d = this.text.getBBox().width + 4 * this.textMargin,
            ...
            i = { x: f, y: h },
            j = [
                { x: f - this.textMargin, y: e },
                { x: f - this.textMargin + d, y: e },
                { x: f - this.textMargin + d + 2 * this.textMargin, y: 0 },
                { x: f - this.textMargin + 2 * this.textMargin, y: 0 },
                { x: f, y: h },
            ],
            k = c(a, i, j);
        k.attr({
            ...
            b.link && k.attr('href', b.link),
            b.target && k.attr('target', b.target),
            b.key && (k.node.id = b.key),
            k.node.setAttribute('class', this.getAttr('class')),
            this.text.attr({ y: k.getBBox().height / 2 }),
            this.group.push(k),
            k.insertBefore(this.text),
            this.initialize();
    }
    function m(a, b) {
        (b = b || {}),
            ...
            b.yes && b.direction_yes && b.no && !b.direction_no
                ? 'right' === b.direction_yes
                  ? ((this.no_direction = 'bottom'),
                    (this.yes_direction = 'right'))
                  : ((this.no_direction = 'right'),
                    (this.yes_direction = 'bottom'))
                : b.yes && !b.direction_yes && b.no && b.direction_no
                  ? 'right' === b.direction_no
                    ? ((this.yes_direction = 'bottom'),
                      (this.no_direction = 'right'))
                    : ((this.yes_direction = 'right'),
                      (this.no_direction = 'bottom'))
    ...
    function n(a) {
        ...
        for (; e.length > 0; ) {
            ...
            if (t.indexOf('=>') >= 0) {
                ...
                if (
                    (w.symbolType.indexOf(': ') >= 0 &&
                        ((u = w.symbolType.split(': ')),
                        (w.symbolType = u[0]),
                        (w.text = u[1])),
                    w.text && w.text.indexOf(':>') >= 0
                        ? ((u = w.text.split(':>')),
                          (w.text = u[0]),
                          (w.link = u[1]))
                        : w.symbolType.indexOf(':>') >= 0 &&
                          ...
                          (w.symbolType = u[0]),
                          (w.link = u[1])),
                    w.symbolType.indexOf('\n') >= 0 &&
                        (w.symbolType = w.symbolType.split('\n')[0]),
                    w.link)
                ) {
                    ...
                    x >= 0 &&
                        y >= 0 &&
                        ((w.target = w.link.substring(x, y)),
                        (w.link = w.link.substring(0, x - 1)));
                }
    ...
    (f.prototype.handle = function(a) {
        ...
        (f.prototype.render = function() {
            var a,
                ...
                f = 0,
                g = 0;
            for (d = 0, e = this.symbols.length; e > d; d++)
                (a = this.symbols[d]),
                    a.width > b && (b = a.width),
            ...
            for (
                this.start.render(), d = 0, e = this.symbols.length;
                e > d;
                d++
            )
                (a = this.symbols[d]), a.renderLines();
            for (
                f = this.maxXFromLine, d = 0, e = this.symbols.length;
                e > d;
                d++
            ) {
                a = this.symbols[d];
        ...
        (g.prototype.getAttr = function(a) {
            ...
            var b,
                ...
                d = this.chart.options.symbols
                    ? this.chart.options.symbols[this.symbolType][a]
                    : void 0;
            return (
                this.chart.options.flowstate &&
                    this.chart.options.flowstate[this.flowstate] &&
                    (b = this.chart.options.flowstate[this.flowstate][a]),
                b || d || c
            );
        }),
            ...
            if (this.next) {
                ...
                if ('right' === this.next_direction) {
                    ...
                    if ((this.next.getLeft(), !this.next.isPositioned)) {
                        this.next.setY(b.y - this.next.height / 2),
                            this.next.shiftX(
                                this.group.getBBox().x + this.width + a
                            );
                        var c = this;
                        !(function e() {
                            for (
                                var b,
                                    d = !1,
                                    f = 0,
                                    g = c.chart.symbols.length;
                                g > f;
                                f++
                            ) {
                                b = c.chart.symbols[f];
                                var h = Math.abs(
                                    b.getCenter().x - c.next.getCenter().x
                                );
                                if (
                                    b.getCenter().y > c.next.getCenter().y &&
                                    h <= c.next.width / 2
                                ) {
                                    d = !0;
                                    break;
                    ...
                    this.next.getTop(),
                        this.next.isPositioned ||
                            (this.next.shiftY(this.getY() + this.height + a),
                            this.next.setX(d.x - this.next.width / 2),
                            (this.next.isPositioned = !0),
                            this.next.render());
                }
            }
        ...
        (g.prototype.drawLineTo = function(a, b, c) {
            ...
            if ((c && 'bottom' !== c) || !q || !s)
                if ((c && 'right' !== c) || !r || !v)
                    if ((c && 'left' !== c) || !r || !u)
                        ...
                        (f = d(this.chart, k, o, b)),
                            (this.leftStart = !0),
                            (a.rightEnd = !0),
                            (w = o.x);
                else
                    (f = d(this.chart, i, p, b)),
                        (this.rightStart = !0),
                        (a.leftEnd = !0),
                        (w = p.x);
            else
                (f = d(this.chart, j, n, b)),
                    (this.bottomStart = !0),
                    (a.topEnd = !0),
                    (w = j.x);
            if (f) {
                for (var A = 0, B = this.chart.lines.length; B > A; A++)
                    for (
                        ...
                        var I = [];
                        I.push(['M', E[G][1], E[G][2]]),
                            I.push(['L', E[G + 1][1], E[G + 1][2]]);
                        for (
                            var J = I[0][1],
                                K = I[0][2],
                                L = I[1][1],
                            ...
                            var P = [];
                            P.push(['M', F[N][1], F[N][2]]),
                                P.push(['L', F[N + 1][1], F[N + 1][2]]);
                            var Q = P[0][1],
                                R = P[0][2],
                                S = P[1][1],
                                T = P[1][2],
            ...
            (!this.chart.maxXFromLine ||
                (this.chart.maxXFromLine && w > this.chart.maxXFromLine)) &&
                (this.chart.maxXFromLine = w);
        }),
        r.inherits(h, g),
        r.inherits(i, g),
        r.inherits(j, g),
        ...
        (m.prototype.render = function() {
                ...
                this.bottom_symbol.getTop(),
                    this.bottom_symbol.isPositioned ||
                        (this.bottom_symbol.shiftY(
                            this.getY() + this.height + a
                        ),
                        this.bottom_symbol.setX(
                            b.x - this.bottom_symbol.width / 2
                        ),
            ...
            if (this.right_symbol) {
                ...
                if (
                    ...
                    this.right_symbol.setY(c.y - this.right_symbol.height / 2),
                    ...
                    !(function e() {
                        for (
                            var b, c = !1, f = 0, g = d.chart.symbols.length;
                            g > f;
                            f++
                        ) {
                            b = d.chart.symbols[f];
                            var h = Math.abs(
                                b.getCenter().x - d.right_symbol.getCenter().x
                            );
                            if (
                                b.getCenter().y >
                                    d.right_symbol.getCenter().y &&
                                h <= d.right_symbol.width / 2
                            ) {
                                c = !0;
                                break;
                            }

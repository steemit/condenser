...
(function() {
                    ...
                    if (aj.length >= 2 && al === '[') {
                        ...
                        if (al !== '\\') {
                            am[an] = aj.replace(/[a-zA-Z]/g, function(ar) {
                                ...
                                return (
                                    '[' +
                                    String.fromCharCode(at & ~32, at | 32) +
                                    ']'
                                );
                            });
                        }
    ...
    function h(af) {
        ...
        ab.push(
            ...
            [R, /^(?:[@_]?[A-Z]+[a-z][A-Za-z_$@0-9]*|\w+_t\b)/, null],
    ...
    c(f([], [[n, /^[\s\S]+/]]), ['uq.val']);
    c(h({ keywords: l, hashComments: true, cStyleComments: true, types: e }), [
        'c',
        'cc',
        'cpp',
        'cxx',
    ...
    c(h({ keywords: J, hashComments: true, multiLineStrings: true }), [
        'bash',
        'bsh',
        'csh',
        'sh',
    ...
    c(h({ keywords: x, cStyleComments: true, regexLiterals: true }), [
        'javascript',
        'js',
    ]);
    c(
    ...
    c(h({ keywords: z, cStyleComments: true, multilineStrings: true }), [
        'rc',
        'rs',
        'rust',
    ]);
    ...
    function w(al, ab) {
        ...
        var am = {};
        function af() {
            var ay = P['PR_SHOULD_USE_CONTINUATION']
                ? ap['now']() + 250
                : Infinity;
            for (; ai < ae.length && ap['now']() < ay; ai++) {
                ...
                for (var ax = aA; (ax = ax.previousSibling); ) {
                    ...
                    if (
                        aF
                            ? !/^\??prettify\b/.test(aF)
                            : aE !== 3 || /\S/.test(ax.nodeValue)
                    ) {
                        break;
                    }
                    if (aF) {
                        aH = {};
                        aF.replace(/\b(\w+)=([\w:.%+-]+)/g, function(
                            aJ,
                            aI,
                            aK
                        ) {

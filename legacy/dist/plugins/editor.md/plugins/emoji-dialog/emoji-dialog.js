    ...
    var factory = function(exports) {
        ...
        exports.fn.emojiDialog = function() {
            ...
            var dialogContent = [
                '<div class="' +
                    classPrefix +
                    'emoji-dialog-box" style="width: 760px;height: 334px;margin-bottom: 8px;overflow: hidden;">',
            ...
            if (tab.html() === '') {
                ...
                var container =
                    '<div class="' + classPrefix + 'tab-container">';
                ...
                for (var x = 0; x < 4; x++) {
                    ...
                    container +=
                        '<div class="' +
                        classPrefix +
                        'tab-box" style="height: 260px;overflow: hidden;overflow-y: auto;' +
                        display +
                        '"></div>';
                }
            ...
            var drawTable = function() {
                ...
                var pagination = function(data, type) {
                    ...
                    for (var i = 0; i < pageTotal; i++) {
                        var row =
                            '<div class="' + classPrefix + 'grid-table-row">';
                        ...
                        for (var x = 0; x < rowNumber; x++) {
                            ...
                            if (typeof emoji !== 'undefined' && emoji !== '') {
                                ...
                                if (type === 'github-emoji') {
                                    ...
                                    var twemojiSrc =
                                        exports.twemoji.path +
                                        emoji +
                                        exports.twemoji.ext;
                                    img =
                                        '<img src="' +
                                        twemojiSrc +
                                        '" width="24" title="twemoji-' +
                                        emoji +
                                        '" alt="twemoji-' +
                                        emoji +
                                        '" class="emoji twemoji" />';
                                    row +=
                                        '<a href="javascript:;" value=":tw-' +
                                        emoji +
                                        ':" title=":tw-' +
                                        emoji +
                                        ':" class="' +
                ...
                $tab
                    .find('.' + classPrefix + 'emoji-btn')
                    .bind(
                        exports.mouseOrTouch('click', 'touchend'),
                        function() {
            ...
            if (emojiData.length < 1) {
                ...
                $.getJSON(path + 'emoji.json?temp=' + Math.random(), function(
                    json
                ) {
                    if (typeof dialog.loading === 'function') {
            ...
            tab
                .find('li')
                .bind(exports.mouseOrTouch('click', 'touchend'), function() {
                    var $this = $(this);

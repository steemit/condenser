        ...
        exports.fn.tableDialog = function() {
                ...
                dialog = this.createDialog({
                    ...
                    buttons: {
                        enter: [
                            ...
                            function() {
                                var rows = parseInt(
                                    this.find('[data-rows]').val()
                                );
                                var cols = parseInt(
                                    this.find('[data-cols]').val()
                                );
                                var align = this.find(
                                    '[name="table-align"]:checked'
                                ).val();
                                var table = '';
                                var hrLine = '------------';
            ...
            if (faBtns.html() === '') {
                ...
                for (var i = 0, len = icons.length; i < len; i++) {
                    ...
                    var btn =
                        '<a href="javascript:;"><label for="editormd-table-dialog-radio' +
                        i +
                        '" title="' +
                        _lang[i] +
                        '">';
                    btn +=
                        '<input type="radio" name="table-align" id="editormd-table-dialog-radio' +
                        i +
                        '" value="' +
                        values[i] +
                        '"' +

...
(function (factory) {
    ...
    var $ = typeof window.jQuery !== 'undefined' ? window.jQuery : Zepto;
    ...
    var editormd = function editormd(id, options) {
    ...
    editormd.prototype = editormd.fn = {
        ...
        init: function init(id, options) {
            ...
            id = (typeof id === 'undefined' ? 'undefined' : (0, _typeof3.default)(id)) === 'object' ? settings.id : id;
        ...
        setEditorTheme: function setEditorTheme(theme) {
            var settings = this.settings;
        ...
        setCodeMirrorTheme: function setCodeMirrorTheme(theme) {
        ...
        setPreviewTheme: function setPreviewTheme(theme) {
        ...
        getCodeMirrorOption: function getCodeMirrorOption(key) {
        ...
        setCodeMirrorOption: function setCodeMirrorOption(key, value) {
        ...
        extend: function extend() {
            ...
            if ((0, _typeof3.default)(arguments[0]) === 'object' && typeof arguments[0].length === 'undefined') {
        ...
        showToolbar: function showToolbar(callback) {
            var settings = this.settings;
        ...
        hideToolbar: function hideToolbar(callback) {
            var settings = this.settings;
        ...
        setToolbarAutoFixed: function setToolbarAutoFixed(fixed) {
        ...
        dialogShowMask: function dialogShowMask(dialog) {
            $.proxy(editormd.dialogShowMask, this)(dialog);

            return this;
        },

        getToolbarHandles: function getToolbarHandles(name) {
        ...
        createDialog: function createDialog(options) {
        ...
        infoDialogPosition: function infoDialogPosition() {
            ...
            var _infoDialogPosition = function _infoDialogPosition() {
                infoDialog.css({
        ...
        lockScreen: function lockScreen(lock) {
        ...
        registerKeyMaps: function registerKeyMaps(keyMap) {
            var _this = this;
            var cm = this.cm;
            var settings = this.settings;
        ...
        bindScrollEvent: function bindScrollEvent() {
            ...
            var cmBindScroll = function cmBindScroll() {
            ...
            var cmUnbindScroll = function cmUnbindScroll() {
                codeMirror.find('.CodeMirror-scroll').unbind(mouseOrTouch('scroll', 'touchmove'));
            };

            var previewBindScroll = function previewBindScroll() {
            ...
            var previewUnbindScroll = function previewUnbindScroll() {
        ...
        loadedDisplay: function loadedDisplay(recreate) {
        ...
        width: function width(_width) {
            this.editor.css('width', typeof _width === 'number' ? _width + 'px' : _width);
            this.resize();
        ...
        height: function height(_height) {
            this.editor.css('height', typeof _height === 'number' ? _height + 'px' : _height);
            this.resize();
        ...
        replaceSelection: function replaceSelection(value) {
        ...
        insertValue: function insertValue(value) {
        ...
        appendMarkdown: function appendMarkdown(md) {
            var settings = this.settings;
            var cm = this.cm;
        ...
        setMarkdown: function setMarkdown(md) {
        ...
        previewing: function previewing() {
            ...
            var escHandle = function escHandle(event) {
        ...
        executePlugin: function executePlugin(name, path) {
            var _this = this;
            var cm = this.cm;
            var settings = this.settings;
    ...
    editormd.keyMaps = (_editormd$keyMaps = {}, (0, _defineProperty3.default)(_editormd$keyMaps, key + '-1', 'h1'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-2', 'h2'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-3', 'h3'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-4', 'h4'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-5', 'h5'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-6', 'h6'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-B', 'bold'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-D', 'datetime'), (0, _defineProperty3.default)(_editormd$keyMaps, key + 'Ctrl-E', function () {
        // emoji
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-Alt-G', 'goto-line'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-H', 'hr'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-I', 'italic'), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-K', 'code'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Ctrl-L', function CtrlL() {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), (0, _defineProperty3.default)(_editormd$keyMaps, key + '-U', 'list-ul'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-Ctrl-A', function ShiftCtrlA() {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift' + key + '-C', 'code'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift' + key + 'Q', 'quote'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift' + key + 'S', 'del'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift' + key + 'K', 'tex'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-Alt-C', function ShiftAltC() {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-Alt-C', 'code-block'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-H', 'html-entities'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-Alt-H', 'help'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-E', 'emoji'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-U', 'uppercase'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-Alt-U', 'ucwords'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-Alt-U', 'ucfirst'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-Alt-L', 'lowercase'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-I', function () {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-Alt-I', 'image'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-L', 'link'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-O', 'list-ol'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-P', 'preformatted-text'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-' + key + '-T', 'table'), (0, _defineProperty3.default)(_editormd$keyMaps, 'Shift-Alt-P', 'pagebreak'), (0, _defineProperty3.default)(_editormd$keyMaps, 'F9', 'watch'), (0, _defineProperty3.default)(_editormd$keyMaps, 'F10', 'preview'), (0, _defineProperty3.default)(_editormd$keyMaps, 'F11', 'fullscreen'), _editormd$keyMaps);
    ...
    editormd.markdownToHTML = function (id, options) {
        ...
        if (settings.tex) {
            var katexHandle = function katexHandle() {
    ...
    editormd.createDialog = function (options) {
        ...
        var dialogPosition = function dialogPosition() {
            dialog.css({
                top: ($(window).height() - dialog.height()) / 2 + 'px',
                left: ($(window).width() - dialog.width()) / 2 + 'px'
            });
        ...
        if ((0, _typeof3.default)(options.buttons) === 'object') {
        ...
        if (options.title !== '' && options.drag) {
            ...
            var userCanSelect = function userCanSelect(obj) {
                obj.removeClass(classPrefix + 'user-unselect').off('selectstart');
            };

            var userUnselect = function userUnselect(obj) {
    ...
    editormd.dateFormat = function (format) {
        ...
        var addZero = function addZero(d) {
            return d < 10 ? '0' + d : d;
        };

                ...
                switch (state.mode) {
                    ...
                    default:
                        ...
                        */
                            ...
                            if (ch == '(')
                                while (
                                    (letter = stream.eat(tests.keyword_char)) !=
                                    null
                                ) {
                                    keyWord += letter;
                                }
                            ...
                            if (
                                ...
                                builtins &&
                                builtins.propertyIsEnumerable(stream.current())
                            ) {
                                returnType = BUILTIN;
                            } else if (
                                atoms &&
                                atoms.propertyIsEnumerable(stream.current())
                            ) {
                                returnType = ATOM;
                            } else {
                                returnType = VAR;

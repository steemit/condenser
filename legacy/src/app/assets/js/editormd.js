(function(factory) {
    ...
    editormd.prototype = editormd.fn = {
        ...
        init: function(id, options) {
            ...
            if (markdownTextarea.length < 1) {
                ...
                markdownTextarea = this.markdownTextarea = editor.children(
                    'textarea'
                );
            }
            ...
            this.containerMask = editor.children(
                '.' + classPrefix + 'container-mask'
            );
            ...
            if (settings.appendMarkdown !== '') {
                markdownTextarea.val(
                    markdownTextarea.val() + settings.appendMarkdown
                );
            }
            ...
            if (typeof define === 'function' && define.amd) {
                ...
                if (settings.searchReplace && !settings.readOnly) {
                    editormd.loadCSS(
                        settings.path + 'codemirror/addon/dialog/dialog'
                    );
                    editormd.loadCSS(
                        settings.path +
        ...
        loadQueues: function() {
            ...
            var loadFlowChartOrSequenceDiagram = function() {
                ...
                if (settings.flowChart || settings.sequenceDiagram) {
                    editormd.loadScript(loadPath + 'raphael.min', function() {
                        editormd.loadScript(
                            loadPath + 'underscore.min',
                            function() {
                                if (
                                    !settings.flowChart &&
                                    settings.sequenceDiagram
                                ) {
                                    editormd.loadScript(
                                    ...
                                    editormd.loadScript(
                                        loadPath + 'flowchart.min',
                                        function() {
                                            editormd.loadScript(
                                                loadPath +
                                                    'jquery.flowchart.min',
                                                function() {
                                                    _this.loadedDisplay();
                                                }
                                            );
            ...
            editormd.loadScript(
                loadPath + 'codemirror/codemirror.min',
                function() {
                    editormd.$CodeMirror = CodeMirror;

                    editormd.loadScript(
                        loadPath + 'codemirror/modes.min',
                        function() {
                            editormd.loadScript(
                                loadPath + 'codemirror/addons.min',
                                function() {
                                    _this.setCodeMirror();
        ...
        setTheme: function(theme) {
            ...
            editor
                .removeClass(themePrefix + oldTheme)
        ...
        setCodeMirror: function() {
            ...
            var codeMirrorConfig = {
                ...
                highlightSelectionMatches: !settings.matchWordHighlight
                    ...
                    : {
                          showToken:
                              settings.matchWordHighlight === 'onselected'
                                  ? false
                                  : /\w/,
                      },
            };
        ...
        setToolbar: function() {
            ...
            for (var i = 0, len = icons.length; i < len; i++) {
                ...
                if (name === '||') {
                    ...
                    iconTexts =
                        typeof iconTexts === 'undefined' ? '' : iconTexts;
                    iconClass =
                        typeof iconClass === 'undefined' ? '' : iconClass;
                    ...
                    if (
                        typeof settings.toolbarCustomIcons[name] !==
                            'undefined' &&
            ...
            toolbarIcons.bind(
                ...
                function(event) {
                    ...
                    if (typeof toolbarIconHandlers[name] !== 'undefined') {
                        ...
                        if (
                            typeof settings.toolbarHandlers[name] !==
                            'undefined'
                        ) {
        ...
        flowChartAndSequenceDiagramRender: function() {
            ...
            if (scrollTop === 0) {
                ...
                preview.scrollTop(
                    (preview[0].scrollHeight + tocHeight + tocMenuHeight) *
                        percent
                );
            }
        ...
        registerKeyMaps: function(keyMap) {
            ...
            if (keyMap) {
                ...
                $(window).keydown(function(event) {
                    ...
                    if (
                        $.inArray(keymaps[event.keyCode], disabledKeyMaps) < 0
                    ) {
            ...
            var cmBindScroll = function() {
                codeMirror
                    ...
                    .bind(mouseOrTouch('scroll', 'touchmove'), function(event) {
                        ...
                        var tocMenuHeight = preview
                            .find('.editormd-toc-menu')
                            .height();
                        tocMenuHeight = !tocMenuHeight ? 0 : tocMenuHeight;
                        ...
                        if (scrollTop === 0) {
                            ...
                            scrollTop + height >=
                            $(this)[0].scrollHeight - 16
                        ) {
                            preview.scrollTop(preview[0].scrollHeight);
                        } else {
                            preview.scrollTop(
                                (preview[0].scrollHeight +
                                    tocHeight +
                                    tocMenuHeight) *
                                    percent
                            );
        ...
        loadedDisplay: function(recreate) {
            ...
            editor
                .data('oldWidth', editor.width())
                .data('oldHeight', editor.height()); // 为了兼容Zepto
        ...
        resize: function(width, height) {
            ...
            if (settings.watch) {
                ...
                preview.width(
                    !state.preview ? editor.width() / 2 : editor.width()
                );
                ...
                if (settings.toc) {
                    var tocContainer =
                        settings.tocContainer === ''
                            ? previewContainer
                            : $(settings.tocContainer);
                    var tocMenu = tocContainer.find(
                        '.' + this.classPrefix + 'toc-menu'
                    );
                    ...
                    if (
                        settings.tocDropdown ||
                        tocContainer.find('.' + this.classPrefix + 'toc-menu')
                            .length > 0
                    ) {
        ...
        previewed: function() {
            ...
            previewCloseBtn
                .hide()
                .unbind(editormd.mouseOrTouch('click', 'touchend'));
            ...
            for (var i = 0, len = matchs.length; i < len; i++) {
                ...
                text = text.replace(new RegExp(matchs[i]), function($1, $2) {
                    ...
                    if (faMatchs) {
                        ...
                        if (emdlogoMathcs) {
                            for (
                                var x = 0, len2 = emdlogoMathcs.length;
                                x < len2;
                                x++
                            ) {
                                var logoName = emdlogoMathcs[x].replace(
                                    /:/g,
                                    ''
                                );
                                return (
                            ...
                            for (
                                var t = 0, len3 = twemojiMatchs.length;
                                t < len3;
                                t++
                            ) {
                                var twe = twemojiMatchs[t]
                                    .replace(/:/g, '')
                                    .replace('tw-', '');
                                return (
                                    '<img src="' +
        ...
        markedRenderer.atLink = function(text) {
            if (atLinkReg.test(text)) {
                ...
                if (settings.emailLink) {
                    text = text.replace(emailLinkReg, function(
                        $1,
                        $2,
                        $3,
                        $4,
    ...
    editormd.markdownToCRenderer = function(
        ...
        if (tocDropdown) {
            tocContainer.wrap(
                '<div class="' + classPrefix + 'toc-menu"></div><br/>'
            );
        }
    ...
    editormd.tocDropdownMenu = function(container, tocTitle) {
        ...
        tocMenus.each(function() {
            ...
            list
                .first()
                .before('<li><h1>' + tocTitle + ' ' + icon + '</h1></li>');
        ...
        if (typeof attrs !== 'undefined') {
            ...
            if (attrs === '*') {
                ...
                html = html.replace(htmlTagRegex, function($1, $2, $3, $4, $5) {
                    ...
                    var text =
                        typeof el[1] !== 'undefined' ? $(el[1]).text() : '';
    ...
    editormd.markdownToHTML = function(id, options) {
        ...
        if (settings.tex) {
            ...
            if (
                settings.autoLoadKaTeX &&
                !editormd.$katex &&
                !editormd.kaTeXLoaded
            ) {
    ...
    editormd.createDialog = function(options) {
        ...
        if (options.title !== '' && options.drag) {
            var posX, posY;
            var dialogHeader = dialog.children(
                '.' + classPrefix + 'dialog-header'
            );

            if (!options.mask) {
                dialogHeader.bind(
                    mouseOrTouch('click', 'touchend'),
                    function() {
            ...
            var userCanSelect = function(obj) {
                obj
                    .removeClass(classPrefix + 'user-unselect')
                    .off('selectstart');
            };

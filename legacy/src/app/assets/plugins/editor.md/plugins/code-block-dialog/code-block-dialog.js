        ...
        exports.fn.codeBlockDialog = function() {
            ...
            if (editor.find('.' + dialogName).length > 0) {
                ...
                var dialogHTML =
                    ...
                    dialogLang.selectDefaultText +
                    '</option></select>' +
                    '</div>' +
                    '<textarea placeholder="coding now...." style="display:none;">' +
                    selection +
                    '</textarea>';
            ...
            if (dialog.find('.CodeMirror').length < 1) {
                cmEditor = exports.$CodeMirror.fromTextArea(
                    textarea[0],
                    cmConfig
                );

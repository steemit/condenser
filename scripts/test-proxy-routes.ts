...
const testCases = [
  ...
  { path: '/post/@alice/my-post/', expected: 'next', description: 'Trailing-slash post URL under /post passes the guard (@-segment) → Next 308 normalization re-enters branch 2' },

...
function crypt(private_key, public_key, nonce, message, checksum) {
    ...
    const iv = CryptoJS.enc.Hex.parse(
        encryption_key.toString("hex").substring(64, 96)
    );
    const key = CryptoJS.enc.Hex.parse(
        encryption_key.toString("hex").substring(0, 64)
    );
...
function cryptoJsDecrypt(message, key, iv) {
    ...
    message = CryptoJS.AES.decrypt({ ciphertext: message, salt: null }, key, {
        iv
    });
...
function uniqueNonce() {
    ...
    const entropy = ++unique_nonce_entropy % 65535;
...
const toPrivateObj = o => o
    ? o.d ? o : PrivateKey.fromWif(o)
    : o /*null or undefined*/;
const toPublicObj = o => o
    ? o.Q ? o : PublicKey.fromString(o)
    : o /*null or undefined*/;
const toLongObj = o => o ? Long.isLong(o) ? o : Long.fromString(o) : o;
const toBinaryBuffer = o => o
    ? Buffer.isBuffer(o) ? o : new Buffer(o, "binary")
    : o;
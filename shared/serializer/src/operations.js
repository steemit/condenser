...
let price = new Serializer("price", { base: asset, quote: asset });
...
let authority = new Serializer("authority", {
...
let pow2 = new Serializer("pow2", { input: pow2_input, pow_summary: uint32 });
...
let interest = new Serializer("interest", { owner: string, interest: asset });

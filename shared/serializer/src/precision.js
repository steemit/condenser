...
module.exports = _my = // Result may be used for int64 types (like transfer amount).  Asset's
...
module.exports._internal = _internal = // Warning: Long operations may over-flow without detection
{

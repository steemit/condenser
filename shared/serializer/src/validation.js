...
module.exports = _my = {
    ...
    get_instance: get_instance = function(
        reserve_spaces,
        type,
        value,
        field_name
    ...
    require_relative_type: require_relative_type = function(
        type,
        value,
        field_name
    ) {
    ...
    get_relative_instance: get_relative_instance = function(
        type,
        value,
        field_name
    ) {
    ...
    require_protocol_type: require_protocol_type = function(
        type,
        value,
        field_name
    ) {
    ...
    get_protocol_instance: get_protocol_instance = function(
        type,
        value,
        field_name
    ) {
    ...
    require_implementation_type: require_implementation_type = function(
        type,
        value,
        field_name
    ) {
    ...
    get_implementation_instance: get_implementation_instance = function(
        type,
        value,
        field_name
    ) {

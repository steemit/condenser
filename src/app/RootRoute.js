...
export default {
  ...
  getChildRoutes(nextState, cb) {
    ...
    if (route.page === 'About') {
      ...
      //require.ensure([], (require) => {
      cb(null, [require('app/components/Steemit/pages/ChangePasswordPage')]);
      //});
      ...
      //require.ensure([], (require) => {
      cb(null, [require('app/components/Steemit/pages/RecoverAccountStep1')]);
      //});
    } else if (route.page === 'RecoverAccountStep2') {
      //require.ensure([], (require) => {
      cb(null, [require('app/components/Steemit/pages/RecoverAccountStep2')]);
      //});
      ...
      cb(null, [require('app/components/Steemit/pages/PostPageNoCategory')]);

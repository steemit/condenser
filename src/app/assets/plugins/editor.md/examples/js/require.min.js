    ...
    function ga(b) {
        ...
        function n(a) {
            var k,
                c = a ? a.indexOf('!') : -1;
            -1 < c &&
                ((k = a.substring(0, c)), (a = a.substring(c + 1, a.length)));
            return [k, a];
        }
        function p(a, k, b, f) {
            var l,
        ...
        function D() {
            var a,
                ...
                c =
                    (a = 1e3 * j.waitSeconds) &&
                    i.startTime + a < new Date().getTime(),
                f = [],
                l = [],
                g = !1,
                h = !0;
        ...
        i = {
                ...
                a.packages &&
                    v(a.packages, function(a) {
                        ...
                        j.pkgs[b] =
                            a.name +
                            '/' +
                            (a.main || 'main').replace(ia, '').replace(Q, '');
                    });
                B(h, function(a, b) {
            ...
            makeRequire: function(a, e) {
                function j(c, d, m) {
                    ...
                    if ('string' === typeof c) {
                        if (G(d))
                            return w(
                                C('requireargs', 'Invalid require call'),
                                m
                            );
            ...
            onScriptError: function(a) {
                ...
                if (!e(b.id))
                    return w(
                        C('scripterror', 'Script error for: ' + b.id, a, [b.id])
                    );
            },
        };

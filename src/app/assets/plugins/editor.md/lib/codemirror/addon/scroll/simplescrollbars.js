    ...
    function Bar(cls, orientation, scroll) {
        ...
        CodeMirror.on(this.inner, 'mousedown', function(e) {
            ...
            function move(e) {
                ...
                self.moveTo(
                    startpos + (e[axis] - start) * (self.total / self.size)
                );
            }
        ...
        CodeMirror.on(this.node, 'click', function(e) {
            ...
            if (self.orientation == 'horizontal')
                where =
                    e.clientX < innerBox.left
                        ? -1
                        : e.clientX > innerBox.right ? 1 : 0;
            else
                where =
                    e.clientY < innerBox.top
                        ? -1
                        : e.clientY > innerBox.bottom ? 1 : 0;
            self.moveTo(self.pos + where * self.screen);
        });

        function onWheel(e) {
            var moved = CodeMirror.wheelEventPixels(e)[

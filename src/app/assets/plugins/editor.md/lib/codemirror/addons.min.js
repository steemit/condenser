...
!(function(e) {
    ...
    e.defineOption('showTrailingSpace', !1, function(t, i, o) {
        o == e.Init && (o = !1),
            o && !i
                ? t.removeOverlay('trailingspace')
                : !o &&
                  i &&
                  t.addOverlay({
                      token: function(e) {
                          for (
                              var t = e.string.length, i = t;
                              i && /\s/.test(e.string.charAt(i - 1));
                              --i
                          );
                          return i > e.pos
                              ? ((e.pos = i), null)
    ...
    (function(e) {
        ...
        e.defineExtension('openDialog', function(o, r, n) {
            ...
            return (
                h
                    ? (n.value && ((h.value = n.value), h.select()),
                      n.onInput &&
                          e.on(h, 'input', function(e) {
                              n.onInput(e, h.value, a);
                          }),
                      n.onKeyUp &&
                          e.on(h, 'keyup', function(e) {
                              n.onKeyUp(e, h.value, a);
                          }),
                      e.on(h, 'keydown', function(t) {
                          (n && n.onKeyDown && n.onKeyDown(t, h.value, a)) ||
                              ((27 == t.keyCode ||
                                  (n.closeOnEnter !== !1 && 13 == t.keyCode)) &&
                                  (h.blur(), e.e_stop(t), a()),
                              13 == t.keyCode && r(h.value, t));
                      }),
                      n.closeOnBlur !== !1 && e.on(h, 'blur', a),
                      h.focus())
                    : (s = l.getElementsByTagName('button')[0]) &&
                      (e.on(s, 'click', function() {
                          a(), d.focus();
                      }),
                      n.closeOnBlur !== !1 && e.on(s, 'blur', a),
                      s.focus()),
                a
            );
        }),
    ...
    (function(e) {
        ...
        function t(e, t, r, n) {
            if (
                ((this.atOccurrence = !1),
                (this.doc = e),
                null == n && 'string' == typeof t && (n = !1),
                (r = r ? e.clipPos(r) : o(0, 0)),
                (this.pos = { from: r, to: r }),
                'string' != typeof t)
            )
                t.global ||
                    (t = new RegExp(t.source, t.ignoreCase ? 'ig' : 'g')),
                    (this.matches = function(i, r) {
                        if (i) {
                            ...
                            for (
                                var n,
                                    a,
                                    s = e.getLine(r.line).slice(0, r.ch),
                                    l = 0;
                                ;
                ...
                if (1 == l.length)
                    ...
                    this.matches = function(t, i) {
                        ...
                        if (t) {
                            ...
                            if (
                                s(e.getLine(i.line).slice(0, c[r].length)) !=
                                l[l.length - 1]
                            )
                                return;
                            for (
                                var n = o(i.line, c[r].length),
                                    a = i.line - 1,
                                    d = r - 1;
                                d >= 1;
                                --d, --a
                        ...
                        if (!(i.line + (l.length - 1) > e.lastLine())) {
                            ...
                            if (s(h.slice(u)) == l[0]) {
                                for (
                                    var f = o(i.line, u), a = i.line + 1, d = 1;
                                    r > d;
                                    ++d, ++a
                                )
                                    if (l[d] != s(e.getLine(a))) return;
                                if (
                                    s(e.getLine(a).slice(0, c[r].length)) ==
                                    l[r]
                                )
                                    return { from: f, to: o(a, c[r].length) };
                            }
                        }
                    };
                }
        ...
        (t.prototype = {
            ...
            find: function(e) {
                function t(e) {
                    var t = o(e, 0);
                    return (
                        (i.pos = { from: t, to: t }), (i.atOccurrence = !1), !1
                    );
                }
                for (
                    var i = this,
            ...
            e.defineExtension('selectMatches', function(t, i) {
                for (
                    var o,
                        r = [],
                        n = this.getSearchCursor(t, this.getCursor('from'), i);
                    (o = n.findNext()) &&
                    !(e.cmpPos(n.to(), this.getCursor('to')) > 0);
    ...
    (function(e) {
            ...
            return (
                      ...
                      (e = new RegExp(e.source, e.ignoreCase ? 'gi' : 'g')),
                {
                    token: function(t) {
                        ...
                        return i && i.index == t.pos
                            ? ((t.pos += i[0].length), 'searching')
                            : void (i ? (t.pos = i.index) : t.skipToEnd());
                    },
                }
            );
        }
        ...
        function a(e, t, i, o, r) {
            e.openDialog ? e.openDialog(t, r, { value: o }) : r(prompt(i, o));
        }
        function s(e, t, i, o) {
        ...
        function l(e) {
            ...
            return (
                ('string' == typeof e ? '' == e : e.test('')) && (e = /x^/), e
            );
        }
        function c(e, i) {
            var n = o(e);
            return n.query
                ? d(e, i)
                : void a(e, f, 'Search for:', e.getSelection(), function(o) {
                      e.operation(function() {
                          o &&
                              !n.query &&
                              ((n.query = l(o)),
                              e.removeOverlay(n.overlay, r(n.query)),
                              (n.overlay = t(n.query, r(n.query))),
                              e.addOverlay(n.overlay),
                              e.showMatchesOnScrollbar &&
                                  (n.annotate &&
                                      (n.annotate.clear(), (n.annotate = null)),
                                  (n.annotate = e.showMatchesOnScrollbar(
                                      n.query,
                                      r(n.query)
                                  ))),
                              (n.posFrom = n.posTo = e.getCursor()),
                              d(e, i));
                      });
                  });
        }
            ...
            t.operation(function() {
                ...
                (a.find(i) ||
                    ((a = n(
                        t,
                        r.query,
                        i ? e.Pos(t.lastLine()) : e.Pos(t.firstLine(), 0)
                    )),
                    a.find(i))) &&
                    (t.setSelection(a.from(), a.to()),
                    t.scrollIntoView({ from: a.from(), to: a.to() }),
                    (r.posFrom = a.from()),
                    (r.posTo = a.to()));
            });
        }
        ...
        function u(e, t) {
            e.getOption('readOnly') ||
                a(e, g, 'Replace:', e.getSelection(), function(i) {
                    i &&
                        ((i = l(i)),
                        a(e, p, 'Replace with:', '', function(o) {
                            if (t)
                                e.operation(function() {
    ...
    (function(e) {
        ...
        function t(e, t) {
            ...
            (this.cm = e),
                (this.options = t),
                (this.buttonHeight =
                    t.scrollButtonHeight || e.getOption('scrollButtonHeight')),
                (this.annotations = []),
        ...
        e.defineExtension('annotateScrollbar', function(e) {
            return (
                'string' == typeof e && (e = { className: e }), new t(this, e)
            );
        }),
            ...
            (t.prototype.computeScale = function() {
                var e = this.cm,
                    t =
                        (e.getWrapperElement().clientHeight -
                            e.display.barHeight -
                            2 * this.buttonHeight) /
                        e.heightAtLine(e.lastLine() + 1, 'local');
            ...
            (t.prototype.redraw = function(e) {
                ...
                if (t.display.barWidth)
                    for (var n, a = 0; a < r.length; a++) {
                        for (
                            var s = r[a],
                                l = n || t.charCoords(s.from, 'local').top * i,
                                c = t.charCoords(s.to, 'local').bottom * i;
                            a < r.length - 1 &&
                            ((n = t.charCoords(r[a + 1].from, 'local').top * i),
                            !(n > c + 0.9));
    ...
    (function(e) {
        ...
        (t.prototype.findMatches = function() {
            if (this.gap) {
                ...
                for (
                    var r = this.cm.getSearchCursor(
                        this.query,
                        e.Pos(this.gap.from, 0),
                        this.caseFold
                    );
                    r.findNext();

                ) {
                    var i = { from: r.from(), to: r.to() };
                    if (i.from.line >= this.gap.to) break;
                    if (
                        (this.matches.splice(t++, 0, i),
            ...
            (t.prototype.onChange = function(t) {
                ...
                if (
                    (this.gap
                        ...
                        : (this.gap = { from: t.from.line, to: r + 1 }),
                    n)
                )
    ...
    (function(e) {
        ...
        function i(e) {
            ...
            (i.style.cssText = 'height: 0; overflow: visible'),
                ...
                i.appendChild(
                    document.createTextNode(e.getOption('placeholder'))
                ),
        ...
        function r(e) {
            var o = e.getWrapperElement(),
                r = n(e);
            (o.className =
                o.className.replace(' CodeMirror-empty', '') +
                (r ? ' CodeMirror-empty' : '')),
                r ? i(e) : t(e);
        }
        function n(e) {
    ...
    (function(e) {
        ...
        function t(t) {
            ...
            for (var l = i.length - 1; l >= 0; l--) {
                ...
                (k[l] = { head: y.newPos, anchor: y.newPos }),
                    t.setSelections(k),
                    y.indent &&
                        (t.indentLine(y.newPos.line, null, !0),
                        t.indentLine(y.newPos.line + 1, null, !0));
            }
        }
        function i(t, i) {
            for (
                var o = t.listSelections(), r = [], a = i ? '/' : '</', s = 0;
                s < o.length;
                s++
            ) {
            ...
            for (var s = 0; s < o.length; s++)
                (s == o.length - 1 || o[s].head.line < o[s + 1].head.line) &&
                    t.indentLine(o[s].head.line);
        }
        function o(t) {
    ...
    (function(e) {
        ...
        function t(t, r, n, a) {
            ...
            var c = o(t, n, 'minFoldSize'),
                d = s(!0);
            if (o(t, n, 'scanUp'))
                for (; !d && r.line > t.firstLine(); )
                    (r = e.Pos(r.line - 1, 0)), (d = s(!1));
        ...
        (e.newFoldFunction = function(e, i) {
            ...
            (e.commands.foldAll = function(t) {
                t.operation(function() {
                    for (var i = t.firstLine(), o = t.lastLine(); o >= i; i++)
                        t.foldCode(e.Pos(i, 0), null, 'fold');
                });
            }),
            (e.commands.unfoldAll = function(t) {
                t.operation(function() {
                    for (var i = t.firstLine(), o = t.lastLine(); o >= i; i++)
                        t.foldCode(e.Pos(i, 0), null, 'unfold');
                });
            }),
    ...
    (function(e) {
                ...
                clearTimeout(t.changeUpdate),
                    (t.changeUpdate = setTimeout(function() {
                        ...
                        t.from - i.to > 20
                            ...
                            : e.operation(function() {
                                  i.from < t.from &&
                                      (n(e, i.from, t.from), (t.from = i.from)),
                                      i.to > t.to &&
                                          (n(e, t.to, i.to), (t.to = i.to));
                              });
        ...
        e.defineOption('foldGutter', !1, function(o, r, n) {
            n &&
                n != e.Init &&
                (o.clearGutter(o.state.foldGutter.options.gutter),
                (o.state.foldGutter = null),
                o.off('gutterClick', s),
                o.off('change', l),
                o.off('viewportChange', c),
                o.off('fold', d),
                o.off('unfold', d),
                o.off('swapDoc', a)),
                r &&
                    ((o.state.foldGutter = new t(i(r))),
                    a(o),
                    o.on('gutterClick', s),
                    o.on('change', l),
                    o.on('viewportChange', c),
                    o.on('fold', d),
                    o.on('unfold', d),
                    o.on('swapDoc', a));
        });
    ...
    (function(e) {
        ...
        e.registerHelper('fold', 'brace', function(t, i) {
            function o(o) {
                for (var r = i.ch, l = 0; ; ) {
                    ...
                    if (-1 != c) {
                        if (1 == l && c < i.ch) break;
                        if (
                            ((n = t.getTokenTypeAt(e.Pos(a, c + 1))),
                            !/^(comment|string)/.test(n))
                        )
                            return c + 1;
                        r = c - 1;
                    } else {
            ...
            if (
                ...
                if (null != d && (a != d || h != r))
                    return { from: e.Pos(a, r), to: e.Pos(d, h) };
            }
        }),
            e.registerHelper('fold', 'import', function(t, i) {
                function o(i) {
                    ...
                    if (
                        (/\S/.test(o.string) ||
                            (o = t.getTokenAt(e.Pos(i, o.end + 1))),
                        'keyword' != o.type || 'import' != o.string)
                    )
                        return null;
                    for (
                        var r = i, n = Math.min(t.lastLine(), i + 10);
                        n >= r;
                        ++r
                    ) {
                        var a = t.getLine(r),
                            s = a.indexOf(';');
                        if (-1 != s)
                            return { startCh: o.end, end: e.Pos(r, s) };
                    }
                }
                var r,
                    i = i.line,
                    n = o(i);
                if (!n || o(i - 1) || ((r = o(i - 2)) && r.end.line == i - 1))
                    return null;
                for (var a = n.end; ; ) {
                    var s = o(a.line + 1);
                    if (null == s) break;
                ...
                return { from: t.clipPos(e.Pos(i, n.startCh + 1)), to: a };
            }),
            e.registerHelper('fold', 'include', function(t, i) {
                function o(i) {
                    ...
                    return (
                        /\S/.test(o.string) ||
                            (o = t.getTokenAt(e.Pos(i, o.end + 1))),
                        'meta' == o.type && '#include' == o.string.slice(0, 8)
                            ? o.start + 8
                            : void 0
                    );
                }
                ...
                return { from: e.Pos(i, r + 1), to: t.clipPos(e.Pos(n)) };
            });
    }),
    (function(e) {
        'object' == typeof exports && 'object' == typeof module
            ...
            (e.findMatchingTag = function(e, o, r) {
                ...
                if (-1 != n.text.indexOf('>') || -1 != n.text.indexOf('<')) {
                    var l = a(n),
                        ...
                        f = l && s(n);
                    if (l && f && !(t(n, o) > 0)) {
                        var g = { from: u(n.line, n.ch), to: c, tag: f[2] };
                        return 'selfClose' == l
                            ? { open: g, close: null, at: 'open' }
                            : f[1]
                              ? { open: h(n, f[2]), close: g, at: 'close' }
                              : ((n = new i(e, c.line, c.ch, r)),
                                { open: g, close: d(n, f[2]), at: 'open' });
                    }
                }
            }),
            (e.findEnclosingTag = function(e, t, o) {
                for (var r = new i(e, t.line, t.ch, o); ; ) {
                    ...
                    var a = new i(e, t.line, t.ch, o),
                        s = d(a, n.tag);
                    if (s) return { open: n, close: s };
                }
            }),
            (e.scanForClosingTag = function(e, t, o, r) {
                var n = new i(e, t.line, t.ch, r ? { from: 0, to: r } : null);
                return d(n, o);
            });
    }),
    (function(e) {
        ...
        e.registerHelper('fold', 'markdown', function(t, i) {
            ...
            for (
                var c = t.lastLine(), d = i.line, h = t.getLine(d + 2);
                c > d && !(r(d + 1, s, h) <= l);

            )
                ++d, (s = h), (h = t.getLine(d + 2));
            return {
    ...
    (function(e) {
        ...
        e.registerGlobalHelper(
            ...
            function(t, i) {
                ...
                if (r && n) {
                    for (
                        var a, s = i.line, l = t.getLine(s), c = i.ch, d = 0;
                        ;
                    ...
                    if (null != u && (s != u || f != a))
                        return { from: e.Pos(s, a), to: e.Pos(u, f) };
                }
            }
        );
    }),
    ...
    (function(e) {
        ...
        function t(e) {
            for (var t = 0; t < e.state.activeLines.length; t++)
                e.removeLineClass(e.state.activeLines[t], 'wrap', n),
        ...
        function o(e, o) {
            ...
            i(e.state.activeLines, r) ||
                e.operation(function() {
                    t(e);
                    for (var i = 0; i < r.length; i++)
                        e.addLineClass(r[i], 'wrap', n),
        ...
        e.defineOption('styleActiveLine', !1, function(i, n, a) {
            ...
            n && !s
                ? ((i.state.activeLines = []),
                  o(i, i.listSelections()),
                  i.on('beforeSelectionChange', r))
                : !n &&
                  s &&
                  (i.off('beforeSelectionChange', r),
                  t(i),
                  delete i.state.activeLines);
        });
    }),
    (function(e) {
        'object' == typeof exports && 'object' == typeof module
                ...
                (function(t, o) {
                    (a += o),
                        (n["'" + t + "'"] = function(n) {
                            ...
                            for (
                                var s, d, h = n.listSelections(), u = 0;
                                u < h.length;
                                u++
                            ) {
                                var f,
                                ...
                                if (g.empty())
                                    if (t == o && d == o)
                                        ...
                                        if (e.isWordChar(d) || !i(n, p, t))
                                            return e.Pass;
                                        f = 'both';
                                    } else {
                                        if (
                                            !(
                                                n.getLine(p.line).length ==
                                                    p.ch ||
                                                a.indexOf(d) >= 0 ||
                                                l.test(d)
                                            )
                            ...
                            n.operation(function() {
                                if ('skip' == s) n.execCommand('goCharRight');
                                    ...
                                    'both' == s
                                        ? (n.replaceSelection(t + o, null),
                                          n.execCommand('goCharLeft'))
                                        : 'addFour' == s &&
                                          (n.replaceSelection(
                                              t + t + t + t,
                                              'before'
        ...
        e.defineOption('autoCloseBrackets', !1, function(t, i, l) {
            if ((l != e.Init && l && t.removeKeyMap('autoCloseBrackets'), i)) {
                ...
                'string' == typeof i
                    ? (c = i)
                    : 'object' == typeof i &&
                      (null != i.pairs && (c = i.pairs),
                      null != i.triples && (d = i.triples),
                      null != i.explode && (h = i.explode));
                var u = o(c, d);
    ...
    (function(e) {
        ...
        function i(e) {
            ...
            (t.style.width = i.width),
                ...
                window.scrollTo(i.scrollLeft, i.scrollTop),
                e.refresh();
        }
    ...
    (function(e) {
        ...
        function t(e) {
            'object' == typeof e &&
                ((this.minChars = e.minChars),
                (this.style = e.style),
                (this.showToken = e.showToken),
                (this.delay = e.delay),
                (this.wordsOnly = e.wordsOnly)),
                null == this.style && (this.style = l),
                null == this.minChars && (this.minChars = s),
                null == this.delay && (this.delay = c),
                null == this.wordsOnly && (this.wordsOnly = d),
        ...
        function o(e) {
            e.operation(function() {
                ...
                if (
                    (t.overlay &&
                        (e.removeOverlay(t.overlay), (t.overlay = null)),
                    !e.somethingSelected() && t.showToken)
                ) {
                    for (
                        var i = t.showToken === !0 ? /[\w$]/ : t.showToken,
                            o = e.getCursor(),
                            n = e.getLine(o.line),
                            s = o.ch,
                            l = s;
                        s && i.test(n.charAt(s - 1));
                    ...
                    return void (
                        l > s &&
                        e.addOverlay((t.overlay = a(n.slice(s, l), i, t.style)))
                    );
                }
                ...
                if (c.line == d.line && (!t.wordsOnly || r(e, c, d))) {
                    ...
                    h.length >= t.minChars &&
                        e.addOverlay((t.overlay = a(h, !1, t.style)));
                }
            });
        }
        function r(e, t, i) {
        ...
        function a(e, t, i) {
            return {
                token: function(o) {
                    return !o.match(e) || (t && !n(o, t))
                        ? (o.next(),
                          void (o.skipTo(e.charAt(0)) || o.skipToEnd()))
                        : i;
                },
            };
        }
        ...
        e.defineOption('highlightSelectionMatches', !1, function(r, n, a) {
            if (a && a != e.Init) {
                ...
                s && r.removeOverlay(s),
                    clearTimeout(r.state.matchHighlighter.timeout),
                    (r.state.matchHighlighter = null),
                    r.off('cursorActivity', i);
            }
            n &&
                ((r.state.matchHighlighter = new t(n)),
                o(r),

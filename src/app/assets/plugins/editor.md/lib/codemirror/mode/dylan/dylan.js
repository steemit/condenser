...
(function(mod) {
    ...
    CodeMirror.defineMode('dylan', function(_config) {
        ...
        ['keyword', 'definition', 'simpleDefinition', 'signalingCalls'].forEach(
            function(type) {
        ...
        function tokenBase(stream, state) {
            ...
            if (stream.match('define')) {
                ...
                if (wordLookup[stream.current()]) {
                    return ret(
                        wordLookup[stream.current()],
                        styleLookup[stream.current()],
                        stream.current()
                    );

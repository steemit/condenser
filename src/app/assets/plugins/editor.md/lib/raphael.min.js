...
!(function(a) {
    ...
    (function(a, b) {
        ...
        function c(a) {
            ...
            if (c.is(a, V))
                return c._engine.create[D](
                    c,
                    a.splice(0, 3 + c.is(a[0], T))
                ).add(a);
            ...
            for (q = 0; i > q; q++)
                for (var s = 0; k > s; s++) {
                    ...
                    if (z) {
                        ...
                        var A =
                                t.t +
                                Q((z[x] - t[x]) / (u[x] - t[x])) * (u.t - t.t),
                            B =
                                v.t +
                                Q((z[y] - v[y]) / (w[y] - v[y])) * (w.t - v.t);
                        A >= 0 &&
                            1.001 >= A &&
                            B >= 0 &&
                            1.001 >= B &&
            ...
            if (i) {
                if (j) (j.initstatus = f), (j.start = new Date() - j.ms * f);
                    ...
                    for (var y in i)
                        if (
                            i[z](y) &&
                            (db[z](y) || d.paper.customAttributes[z](y))
                        )
                            switch (((r[y] = d.attr(y)),
                            null == r[y] && (r[y] = cb[y]),
                            (s[y] = i[y]),
        ...
        var u,
            ...
            I = String,
            J = 'split',
            K = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'[
                J
            ](H),
            L = {
            ...
            (c.getColor = function(a) {
                ...
                return (
                    ...
                    b.h > 1 &&
                        ...
                        (b.s -= 0.2),
                        b.s <= 0 &&
                            (this.getColor.start = { h: 0, s: 1, b: b.b })),
                    c.hex
                );
            }),
        ...
        var Bb = (c.pathBBox = function(a) {
            ...
            Hb = function(a, b, c, d, e, g, h, i, j, k) {
                ...
                for (var U = [], V = 0, W = o.length; W > V; V++)
                    U[V] =
                        V % 2 ? p(o[V - 1], o[V], n).y : p(o[V], o[V + 1], n).x;
                return U;
            },
            ...
            Jb = f(function(a, b, c, d, e, f, g, h) {
                ...
                return (
                    ...
                    m > 0 &&
                        1 > m &&
                        ((i = Ib(a, b, c, d, e, f, g, h, m)),
                        p.push(i.x),
                        o.push(i.y)),
                    n > 0 &&
                        1 > n &&
                        ((i = Ib(a, b, c, d, e, f, g, h, n)),
                        p.push(i.x),
                        o.push(i.y)),
                    (j = f - 2 * d + b - (h - 2 * f + d)),
                    (k = 2 * (d - b) - 2 * (f - d)),
            ...
            (function(a) {
                ...
                (a.add = function(a, b, c, d, e, f) {
                    ...
                    for (
                        a &&
                            a instanceof o &&
                            (m = [[a.a, a.c, a.e], [a.b, a.d, a.f], [0, 0, 1]]),
                            g = 0;
                        3 > g;
                        g++
                    )
                ...
                Yb = function(a) {
                    for (
                        ...
                        A.win.opera && n.removeChild(l),
                            ...
                            (l.style.display = o),
                            A.win.opera &&
                                (m ? n.insertBefore(l, m) : n.appendChild(l)),
        ...
        ($b.data = function(a, d) {
            ...
            return (
                (e[a] = d), b('raphael.data.set.' + this.id, this, d, a), this
            );
        }),
            ($b.removeData = function(a) {
                return (
                    null == a
                        ? (kb[this.id] = {})
                        : kb[this.id] && delete kb[this.id][a],
                    this
                );
            }),
            ($b.getData = function() {
        ...
        var bc = function(a) {
            var b = a.getBoundingClientRect(),
                ...
                h =
                    b.top +
                    (A.win.pageYOffset || e.scrollTop || d.scrollTop) -
                    f,
                i =
                    b.left +
                    (A.win.pageXOffset || e.scrollLeft || d.scrollLeft) -
                    g;
            return { y: h, x: i };
        };
        (v.getElementByPoint = function(a, b) {
            ...
            ($b.glow = function(a) {
                ...
                var b = {
                        width:
                            (a.width || 10) + (+this.attr('stroke-width') || 1),
                        fill: a.fill || !1,
        ...
        var hc = (c.easing_formulas = {
            ...
            elastic: function(a) {
                return a == !!a
                    ? a
                    : R(2, -10 * a) * N.sin(2 * (a - 0.075) * S / 0.3) + 1;
            },
            bounce: function(a) {
                var b,
                    c = 7.5625,
        ...
        ($b.animateWith = function(a, b, d, e, f, g) {
            ...
            ($b.setTime = function(a, b) {
                return (
                    a && null != b && this.status(a, P(b, a.ms) / a.ms), this
                );
            }),
            ($b.status = function(a, b) {
                ...
                for (c = ic.length; c > f; f++)
                    if (
                        ((d = ic[f]), d.el.id == this.id && (!a || d.anim == a))
                    ) {
            ...
            ($b.resume = function(a) {
                for (var c = 0; c < ic.length; c++)
                    if (ic[c].el.id == this.id && (!a || ic[c].anim == a)) {
                        var d = ic[c];
                        b('raphael.anim.resume.' + this.id, this, d.anim) !==
                            !1 &&
            ...
            ($b.stop = function(a) {
                for (var c = 0; c < ic.length; c++)
                    ic[c].el.id != this.id ||
                        (a && ic[c].anim != a) ||
                        (b('raphael.anim.stop.' + this.id, this, ic[c].anim) !==
                            !1 &&
                            ic.splice(c--, 1));
                return this;
            }),
                            ...
                            if (
                                ((b.glyphs[e] = {
                                    ...
                                    d:
                                        f.d &&
                                        'M' +
                                            f.d.replace(/[mlcxtrv]/g, function(
                                                a
                                            ) {
                                                return (
                                                    {
                ...
                if ((c.is(e, 'string') && (e = this.getFont(e)), e)) {
                    ...
                    for (
                        var o = e.face.bbox[J](w),
                            ...
                            s =
                                +o[1] +
                                ('baseline' == g ? q + +e.face.descent : q / 2),
                            t = 0,
                            u = k.length;
                        u > t;
                        t++
                ...
                if (c.svg) {
                            ...
                            if ('path' == d.type) {
                                ...
                                if (
                                    ...
                                    d._.arrows
                                        ? f
                                          ? (d._.arrows.endPath &&
                                                p[d._.arrows.endPath]--,
                                            d._.arrows.endMarker &&
                                                p[d._.arrows.endMarker]--)
                                          : (d._.arrows.startPath &&
                                                p[d._.arrows.startPath]--,
                                            d._.arrows.startMarker &&
                        ...
                        y = function(d, f) {
                            if (
                                ...
                                if (f[a]('text')) {
                                    ...
                                    for (
                                        m = h.getElementsByTagName('tspan'),
                                            n = 0,
                                            o = m.length;
                                        o > n;
                                        n++
                    ...
                    (Element = function(a, b) {
                        ...
                        ($b.rotate = function(a, c, e) {
                            ...
                            return (
                                this.transform(
                                    this._.transform.concat([['r', a, c, e]])
                                ),
                                this
                            );
                        }),
                        ($b.scale = function(a, c, e, f) {
                            ...
                            return (
                                ...
                                this.transform(
                                    this._.transform.concat([['s', a, c, e, f]])
                                ),
                                this
                            );
                        }),
                        ...
                        ($b.remove = function() {
                            ...
                            if (!this.removed && a.parentNode) {
                                ...
                                b.__set__ && b.__set__.exclude(this),
                                    ...
                                    this.gradient &&
                                        b.defs.removeChild(this.gradient),
                                    c._tear(this, b),
                        ...
                        ($b.attr = function(b, d) {
                            ...
                            for (n in this.paper.customAttributes)
                                if (
                                    ...
                                    m[a](n) &&
                                    c.is(
                                        this.paper.customAttributes[n],
                                        'function'
                                    )
                                ) {
                                    var o = this.paper.customAttributes[
                                        n
                                    ].apply(this, [].concat(m[n]));
                                    this.attrs[n] = m[n];
                        ...
                        (c.prototype.clear = function() {
                            ...
                            (this.bottom = this.top = null),
                                (this.desc = q('desc')).appendChild(
                                    c._g.doc.createTextNode(
                                        'Created with Raphaël ' + c.version
                                    )
                                ),
                ...
                if (c.vml) {
                    ...
                    var A = function(a, c, d) {
                        ...
                        B = function(e, i) {
                                ...
                                i.font && (J.font = i.font),
                                    i['font-family'] &&
                                        (J.fontFamily =
                                            ...
                                            '"'),
                                    i['font-size'] &&
                                        (J.fontSize = i['font-size']),
                                    i['font-weight'] &&
                                        (J.fontWeight = i['font-weight']),
                                    i['font-style'] &&
                                        (J.fontStyle = i['font-style']);
                            }
                            if (
                                ...
                                if (
                                    ...
                                    i['stroke-linejoin'] &&
                                        (P.joinstyle =
                                            i['stroke-linejoin'] || 'miter'),
                                    (P.miterlimit =
                                        i['stroke-miterlimit'] || 8),
                                    i['stroke-linecap'] &&
                                        (P.endcap =
                            ...
                            if ('text' == s.type) {
                                ...
                                (p = U.style),
                                    ...
                                    m['font-family'] &&
                                        (p.fontFamily = m['font-family']),
                                    m['font-weight'] &&
                                        (p.fontWeight = m['font-weight']),
                                    m['font-style'] &&
                                        (p.fontStyle = m['font-style']),
                                    (W =
                                        d(m['font-size'] || (W && W[0])) || 10),
                                    (p.fontSize = W * V + 'px'),
                                    s.textpath.string &&
                        ...
                        C = function(a, f, g) {
                            ...
                            if (
                                ((a.attrs.gradient = f),
                                (f = b(f).replace(c._radial_gradient, function(
                                    a,
                                    b,
                                    c
                                ) {
                            ...
                            if (((a = a.shape || a.node), l.length)) {
                                ...
                                for (
                                    var m = [], p = 0, q = l.length;
                                    q > p;
                                    p++
                                )
                                    l[p].offset &&
                                        m.push(l[p].offset + n + l[p].color);
                                (g.colors = m.length
                                    ? m.join()
                                    : '0% ' + g.color),
                                    'radial' == i
                    ...
                    (D.prototype = E),
                            ...
                            if (n) {
                                for (o in this.paper.customAttributes)
                                    if (
                                        ...
                                        n[a](o) &&
                                        c.is(
                                            this.paper.customAttributes[o],
                                            'function'
                                        )
                                    ) {
                                        var p = this.paper.customAttributes[
                                            o
                                        ].apply(this, [].concat(n[o]));
                                        this.attrs[o] = n[o];
                                        for (var q in p)
                                            p[a](q) && (n[q] = p[q]);
                                    }
                        ...
                        (E.insertAfter = function(a) {
                            return this.removed
                                ? this
                                : (a.constructor == c.st.constructor &&
                                      (a = a[a.length - 1]),
                                  a.node.nextSibling

...
(function() {
    ...
    (m.groupBy = A(function(n, t, r) {
        ...
        (m.toArray = function(n) {
            return n
                ? m.isArray(n)
                  ? l.call(n)
                  : w(n) ? m.map(n, m.identity) : m.values(n)
                : [];
        }),
        (m.size = function(n) {
    ...
    (m.flatten = function(n, t) {
        ...
        (m.intersection = function(n) {
            if (null == n) return [];
            for (
                var t = [], r = arguments.length, e = 0, u = n.length;
                u > e;
                e++
            ) {
                var i = n[e];
        ...
        (m.unzip = function(n) {
            for (
                var t = (n && m.max(n, 'length').length) || 0,
                    r = Array(t),
                    e = 0;
                t > e;
                e++
        ...
        (m.indexOf = function(n, t, r) {
            ...
            if ('number' == typeof r) e = 0 > r ? Math.max(0, u + r) : r;
                ...
                return (e = m.sortedIndex(n, t)), n[e] === t ? e : -1;
    ...
    var E = function(n, t, r, e) {
        ...
        if ((r.push(n), e.push(t), i)) {
            ...
            for (; c--; )
                if (((l = s[c]), !m.has(t, l) || !E(n[l], t[l], r, e)))
                    return !1;
        }

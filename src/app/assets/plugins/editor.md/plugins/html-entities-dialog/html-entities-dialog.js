    ...
    var factory = function(exports) {
        ...
        exports.fn.htmlEntitiesDialog = function() {
            ...
            var dialogContent = [
                '<div class="' +
                    classPrefix +
                    'html-entities-box" style="width: 760px;height: 334px;margin-bottom: 8px;overflow: hidden;overflow-y: auto;">',
            ...
            var drawTable = function() {
                ...
                dialog
                    .find('.' + classPrefix + 'html-entity-btn')
                    .bind(
            ...
            if (entitiesData.length < 1) {
                ...
                $.getJSON(
                    path + pluginName.replace('-dialog', '') + '.json',
                    function(json) {

...
(function(mod) {
    ...
    function SearchBox(cm) {
        ...
        function initElements(el) {
            ...
            self.wholeWordOption = el.querySelector(
                '[action=toggleWholeWords]'
            );

            self.searchInput = self.searchBox.querySelector(
                '.ace_search_field'
            );
            self.replaceInput = self.replaceBox.querySelector(
                '.ace_search_field'
            );
        }
        ...
        this.commands = {
            ...
            toggleCaseSensitive: function() {
                self.caseSensitiveOption.checked = !self.caseSensitiveOption
                    .checked;
                self.$syncOptions();
            },
        ...
        function find(value, options, callback) {
            ...
            if (regExp || wholeWord) {
                if (options.wholeWord) value = '\\b' + value + '\\b';

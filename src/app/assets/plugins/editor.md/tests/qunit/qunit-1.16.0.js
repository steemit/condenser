    ...
    Test.prototype = {
        ...
        hooks: function(handler) {
            ...
            if (
                ...
                hooks.push(
                    this.queueHook(
                        this.module.testEnvironment[handler],
                        handler
                    )
                );
            }
        ...
        valid: function() {
            var include,
                ...
                module =
                    ...
                    QUnit.urlParams.module.toLowerCase(),
                fullName = (
                    this.module.name +
                    ': ' +
                    this.testName
            ...
            if (
                module &&
                (!this.module.name || this.module.name.toLowerCase() !== module)
            ) {
                return false;
            }
...
(function() {
    ...
    QUnit.testStart(function(details) {
        ...
        if (running) {
            running.innerHTML =
                'Running: <br />' + getNameHtml(details.name, details.module);
        }
    });

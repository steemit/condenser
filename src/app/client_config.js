...
export const LIQUID_TICKER = LIQUID_TOKEN_UPPERCASE;
export const VEST_TICKER = 'VESTS';

export const DEBT_TICKER = process.env.TESTNET ? 'TBD' : 'SBD';
export const DEBT_TOKEN_SHORT = process.env.TESTNET ? 'TBD' : 'SBD';

...
import CategorySelector, {
  validateCategory,
} from 'app/components/Steemit/cards/CategorySelector';
// import { validateCategory } from 'app/components/Steemit/cards/CategorySelector';
...
class ReplyEditor extends React.Component {
  ...
  componentWillMount() {
    ...
    if (process.env.BROWSER) {
      ...
      let rte =
        this.props.isStory &&
        JSON.parse(localStorage.getItem('replyEditorData-rte') || RTE_DEFAULT);
      let raw = null;
  ...
  onTitleChange = e => {
    ...
    this.setState({
      titleWarn: hasMarkdown ? tt('reply_editor.markdown_not_supported') : '',
    });
  ...
  showDraftSaved() {
    ...
    // reset animation
    void draft.offsetWidth; // eslint-disable-line

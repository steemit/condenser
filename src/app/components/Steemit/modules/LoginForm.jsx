...
class LoginForm extends Component {
  ...
  constructor(props) {
    ...
    this.onCancel = e => {
      ...
      const errorCallback =
        loginBroadcastOperation && loginBroadcastOperation.get('errorCallback');
  ...
  render() {
          ...
          <div className="column">
            <div className="callout alert">
              ...
              <p>
                ...
                {tt('loginform_jsx.are_well_tested_and_known_to_work_with', {
                  APP_URL,
                })}
              </p>
            </div>
    ...
    const titleText = !isTransfer ? (
      ...
      <h3>
        <span className="OpAction">{tt('loginform_jsx.sign_transfer')}</span>
      </h3>
    );

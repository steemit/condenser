...
class PickAccount extends React.Component {
  ...
  componentDidMount() {
    ...
    if (cryptoTestResult !== undefined) {
      ...
      this.setState({ cryptographyFailure: true }); // eslint-disable-line
    }
  }
  ...
  validateAccountName(name) {
    ...
    if (promise) {
      promise.then(error => this.setState({ name_error: error })).catch(() =>
        this.setState({
          name_error:
  ...
  content() {
        ...
        <div className="row">
          <div className="column">
            <div className="callout alert">
              ...
              <p>
                We will be unable to create your Steem account with this
                browser.
              </p>
              <p>
      ...
      return (
        <div className="row">
          <div className="column">
            <div className="callout alert">
              <p>
                You need to <a onClick={logout}>Logout</a> before you can create
                an additional account.
              </p>
              <p>
                Please note that Steemit can only register one account per
                verified user.
              </p>
            </div>
          </div>
      ...
      return (
        <div className="row">
          <div className="column">
            ...
            <div className="callout alert">
              <p>
                Your sign up request is being processed and you will receive an
                email from us when it is ready.
              </p>
              <p>
                Signup requests can take up to 7 days to be processed, but
                usually complete in a day or two.
              </p>
            </div>
          </div>
        </div>
    ...
    //         <div className="callout alert">
    //           <p>
    //             Our records indicate that you already have steem account:{' '}
    //             <strong>{existingUserAccount}</strong>
    //           </p>
    //           <p>
    //             In order to prevent abuse Steemit can only register one account
    //             per verified user.
    //           </p>
    //           <p>
    //             You can either <a href="/login.html">login</a> to your existing
    //             account or{' '}
    //             <a href="mailto:support@steemit.com">send us email</a> if you
    //             need a new account.
    //           </p>
    //         </div>
    //       </div>
    ...
    //       <div className="callout alert">
    //         <h5>
    //           Couldn{"'"}t create account. The server returned the following
    //           error:
    //         </h5>
    //         <p>{server_error}</p>
    //       </div>
    ...
    return (
      <div className="AuthForm">
        ...
        <div className="Description">
          Welcome, let us introduce!<br />
          <br />
          <p>
            Your account name is how you will be known on steemit.com.<br />

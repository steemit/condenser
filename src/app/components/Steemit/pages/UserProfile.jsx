...
import UserKeys from 'app/components/Steemit/elements/UserKeys';
import PasswordReset from 'app/components/Steemit/elements/PasswordReset';
import UserWallet from 'app/components/Steemit/modules/UserWallet';
import Settings from 'app/components/Steemit/modules/Settings';
import CurationRewards from 'app/components/Steemit/modules/CurationRewards';
import AuthorRewards from 'app/components/Steemit/modules/AuthorRewards';
import UserList from 'app/components/Steemit/elements/UserList';
import Follow from 'app/components/Steemit/elements/Follow';
import LoadingIndicator from 'app/components/Steemit/elements/LoadingIndicator';
import PostsList from 'app/components/Steemit/cards/PostsList';
import { isFetchingOrRecentlyUpdated } from 'app/utils/StateFunctions';
import { repLog10 } from 'app/utils/ParsersAndFormatters.js';
import Tooltip from 'app/components/Steemit/elements/Tooltip';
import DateJoinWrapper from 'app/components/Steemit/elements/DateJoinWrapper';
import tt from 'counterpart';
// import { List } from 'immutable';
import WalletSubMenu from 'app/components/Steemit/elements/WalletSubMenu';
import Userpic from 'app/components/Steemit/elements/Userpic';
import Callout from 'app/components/Steemit/elements/Callout';
import normalizeProfile from 'app/utils/NormalizeProfile';
import userIllegalContent from 'app/utils/userIllegalContent';
import proxifyImageUrl from 'app/utils/ProxifyUrl';
import ArticleLayoutSelector from 'app/components/Steemit/modules/ArticleLayoutSelector';
import SanitizedLink from 'app/components/Steemit/elements/SanitizedLink';
...
export default class UserProfile extends React.Component {
  ...
  loadMore(last_post, category, showResteem) {
    ...
    if (
      isFetchingOrRecentlyUpdated(this.props.global_status, order, category)
    ) {
      return;
    }
  ...
  render() {
    ...
    if (section === 'transfers') {
      ...
      rewardsClass = 'active';
      tab_content = (
        <CurationRewards account={account} current_user={current_user} />
      );
      ...
      if (account.blog) {
        ...
        const emptyText = isMyAccount ? (
          <div>
            ...
            <br />
            <Link to="/faq.html">{tt('user_profile.browse_the_faq')}</Link>
            <br />
          </div>
        ) : (
      ...
      <div className="row UserProfile__top-menu">
        <div className="columns small-10 medium-12 medium-expand">
          <ul className="menu" style={{ flexWrap: 'wrap' }}>
            <li>
              <Link to={`/@${accountname}`} activeClassName="active">
                {tt('g.blog')}
              </Link>
            </li>
            <li>
              <Link to={`/@${accountname}/comments`} activeClassName="active">
                {tt('g.comments')}
              </Link>
            </li>
            <li>
        ...
        <div className="columns shrink">
          <ul className="menu" style={{ flexWrap: 'wrap' }}>
            ...
            {isMyAccount && (
              <li>
                <Link to={`/@${accountname}/settings`} activeClassName="active">
                  {tt('g.settings')}
                </Link>
              </li>
            )}
    ...
    const { name, location, about, website, cover_image } = normalizeProfile(
      account
    );

...
import { DEBT_TOKEN, DEBT_TICKER, LIQUID_TOKEN } from 'clientConfig';
            ...
            <form onSubmit={handleSubmit(data => {dispatchSubmit(data)})}>
                <div className="row">
                    <div className="small-12 columns">
                        ...
                        <p>{tt('converttosteem_jsx.your_existing_DEBT_TOKEN_are_liquid_and_transferable', {link: tt('g.buy_or_sell'), DEBT_TOKEN})}</p>

        ...
        const form = (
            ...
            >
                ...
                <div>
                    ...
                    <button type="button" className="button sign-up" onClick={this.SignUp}>{tt('loginform_jsx.sign_up_earn_steem')}<span className="free-money">{tt('loginform_jsx.free_money')}</span></button>
                </div>}
            </form>
        );

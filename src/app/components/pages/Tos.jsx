        ...
        return (
            <div className="Tos row">
                <div className="column">
                    ...
                    <p className="c0">
                        <span className="c1 h">1. Privacy Policy</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            Please refer to our Privacy Policy for information
                            about how we collect, use and disclose information
                            about you.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1 h">2. Eligibility</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1 h">4. Adult-Oriented Content</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            ...
                            background or personal views. As a result, we mark
                            this content as Not Safe For Work (&ldquo;
                        </span>
                    ...
                    <p className="c0">
                        <span className="c1 h">5. Trademarks</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1">
                            6.2. &nbsp;We will use reasonable endeavours to
                            verify the accuracy of any information on the
                            Service but we make no representation or warranty of
                            any kind, express or implied, statutory or
                            otherwise, regarding the contents of the Service,
                            information and functions made accessible through
                            the Service, any hyperlinks to third party websites,
                            nor for any breach of security associated with the
                            transmission of information through the Service or
                            any website linked to by the
                            Service.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            6.3. &nbsp;We will not be responsible or liable to
                            you for any loss and take no responsibility for and
                            will not be liable to you for any use of our
                    ...
                    <p className="c0">
                        <span className="c1">
                            6.4. &nbsp;We make no warranty that the Service or
                            the server that makes it available, are free of
                            viruses or errors, that its content is accurate,
                            that it will be uninterrupted, or that defects will
                            be corrected. We will not be responsible or liable
                            to you for any loss of any kind, from action taken,
                            or taken in reliance on material, or information,
                            contained on the
                            Service.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    ...
                    <p className="c0">
                        <span className="c1">
                            6.6. &nbsp;We will not be liable, in contract, or
                            tort (including, without limitation, negligence),
                            other than where we have been fraudulent or made
                            negligent misrepresentations.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            6.7. &nbsp;Nothing in these Terms excludes or limits
                            liability for death or personal injury caused by
                            negligence, fraudulent misrepresentation, or any
                            other liability which may not otherwise be limited
                            or excluded under United States law.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1 h">
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            without limitation reasonable legal fees, arising
                            out or relating
                            to:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            7.1.1. &nbsp;Your use of, or conduct in connection
                            with, our Services;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            7.1.2. &nbsp;Any feedback or submissions you provide
                            (see 19 below);
                        </span>
                    </p>
                    <p className="c0">
                    ...
                    <p className="c0">
                        <span className="c1">
                            7.1.4. &nbsp;Violation of any rights of any other
                            person or entity.
                        </span>
                    </p>
                    <p className="c0 c5">
                        <span className="c1">
                            7.2. &nbsp;If you are obligated to indemnify us, we
                            will have the right, in our sole discretion, to
                            control any action or proceeding (at our expense)
                            and determine whether we wish to settle
                            it.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    ...
                    <p className="c0">
                        <span className="c1">
                            8.1. In using our Services, you may view content or
                            utilize services provided by third parties,
                            including links to web pages and services of such
                            parties (&ldquo; Third Party Content&rdquo;). We do
                            not control, endorse or adopt any Third-Party
                            Content and will have no responsibility for Third
                            Party Content including, without limitation,
                            material that may be misleading, incomplete,
                            erroneous, offensive, indecent or otherwise
                            objectionable in your jurisdiction. In addition,
                            your dealings or correspondence with such third
                            parties are solely between you and the third
                            parties. We are not responsible or liable for any
                            loss or damage of any sort incurred as a result of
                            any such dealings and you understand that your use
                            of Third Party Content, and your interactions with
                            third parties, is at your own
                            risk.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            and/or control over, your Wallet: (a) Create a
                            strong password that you do not use for any other
                            website or online service; (b) Provide accurate and
                            truthful information; (c) Maintain and promptly
                            update your Account information; (d) maintain the
                            security of your Account by protecting your Account
                            password and access to your computer and your
                            Account; (e) Promptly notify us if you discover or
                            otherwise suspect any security breaches related to
                            your
                            Account.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            9.2. &nbsp;You hereby accept and acknowledge that
                            you take responsibility for all activities that
                            occur under your Account and accept all risks of any
                            authorized or unauthorized access to your Account,
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            Services provide you with tools to help you remember
                            or recover your password, including by allowing you
                            to set password hints, but the Services cannot
                            generate a new password for your Account. You are
                            solely responsible for remembering your Account
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            carefully before completing them via the Services.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1">
                            10.9. &nbsp;Taxes. It is your responsibility to
                            determine what, if any, taxes apply to the
                            transactions you for which you have submitted
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            you using any Service to which a fee applies.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1 h">
                    ...
                    <p className="c0">
                        <span className="c1">
                            15.1. &nbsp;We may, in our sole discretion and
                            without cost to you, with or without prior notice
                            and at any time, modify or discontinue, temporarily
                            or permanently, any portion of our Services. You are
                            solely responsible for storing, outside of the
                            Services, a backup of any Account and Private Key
                            pair that you maintain in your
                            Wallet.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                    ...
                    <p className="c0">
                        <span className="c1">
                            16.1. We may suspend or terminate your access to the
                            Services in our sole discretion, immediately and
                            without prior notice, and delete or deactivate your
                            Account and all related information and files in
                            such without cost to you, including, for instance,
                            in the event that you breach any term of these
                            Terms. In the event of termination, your access to
                            funds will depend on your access to your backup of
                            your Account data including your Account Name and
                            Private Keys.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1 h">17. User Conduct</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1. When accessing or using the Services, you
                            agree that you will not commit any unlawful act, and
                            that you are solely responsible for your conduct
                            while using our Services. Without limiting the
                            generality of the foregoing, you agree that you will
                            not:
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.1. Use our Services in any manner that could
                            interfere with, disrupt, negatively affect or
                            inhibit other users from fully enjoying our
                            Services, or that could damage, disable, overburden
                    ...
                    <p className="c0">
                        <span className="c1">
                            17.1.2. &nbsp;Use our Services to pay for, support
                            or otherwise engage in any illegal activities,
                            including, but not limited to illegal gambling,
                            fraud, money- laundering, or terrorist activities.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.3. &nbsp;Use any robot, spider, crawler,
                            scraper or other automated means or interface not
                            provided by us to access our Services or to extract
                            data;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.4. &nbsp;Use or attempt to use another
                            user&rsquo;s Wallet without authorization;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.5. &nbsp;Attempt to circumvent any content
                            filtering techniques we employ, or attempt to access
                            any service or area of our Services that you are not
                            authorized to access;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.6. &nbsp; Introduce to the Services any virus,
                            Trojan, worms, logic bombs or other harmful
                            material;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.7. &nbsp; Develop any third-party applications
                            that interact with our Services without our prior
                            written
                            consent;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            17.1.8. &nbsp; Provide false, inaccurate, or
                    ...
                    <p className="c0">
                        <span className="c1">
                            17.1.9. &nbsp;Encourage or induce any third party to
                            engage in any of the activities prohibited under
                            this Section.
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </span>
                    </p>
                    ...
                    <p className="c0">
                        <span className="c1 h">19. Feedback</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1 h">21. Disclaimers</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            LIMITATION OF CERTAIN DAMAGES, SO SOME OR ALL OF THE
                            EXCLUSIONS AND LIMITATIONS IN THIS SECTION MAY NOT
                            APPLY TO YOU.
                        </span>
                    </p>
                    <p className="c0">
                    ...
                    <p className="c0">
                        <span className="c1 h">24. Arbitration</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1">24.1. Binding Arbitration</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            Except for disputes in which either party seeks to
                        ...
                        <span className="c1">
                            ...
                            making a final and binding determination to resolve
                            it, instead of having the Dispute decided by a judge
                            or jury in court).
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            24.2. No Class Arbitrations, Class Actions or
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            PROCEEDING. NEITHER PARTY AGREES TO CLASS
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            the Federal Arbitration Act, 9 U.S.C. &sect; 1 et
                            seq. (the &ldquo;FAA&rdquo;) to the maximum extent
                            permitted by applicable law.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">24.4. Process</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1">
                            As limited by the FAA, these Terms and applicable
                            JAMS rules, the arbitrator will have: (a) the
                            exclusive authority and jurisdiction to make all
                            procedural and substantive decisions regarding a
                            Dispute; and (b) the authority to grant any remedy
                            that would otherwise be available in court. The
                            arbitrator may only conduct an individual
                            arbitration and may not consolidate more than one
                            individual&rsquo; s claims, preside over any type of
                            class or representative proceeding or preside over
                            any proceeding involving more than one individual.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">24.6. Rules of JAMS</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            The rules of, and additional information about, JAMS
                            are available on the JAMS website at{' '}
                        </span>
                        <span className="c4">
                            <a
                                className="c3"
                                href="https://www.google.com/url?q=http://www.jamsadr.com/&amp;sa=D&amp;ust=1461884744556000&amp;usg=AFQjCNGyIPoxCZmvcVtmcAa4IxnRo2Rb4Q"
                            >
                                http://www.jamsadr.com/
                            </a>
                        </span>
                        <span className="c1">
                            , as may be updated from time to time. By agreeing
                            to be bound by these Terms, you either: (a)
                            acknowledge and agree that you have read and
                            understand the rules of JAMS; or (b) waive your
                            opportunity to read the rules of JAMS and any claim
                            that the rules of JAMS are unfair or should not
                            apply for any reason.
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1">24.7. Severability</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            If any term, clause or provision of this Section 14
                            is held invalid or unenforceable, it will be so held
                            to the minimum extent required by law and all other
                            terms, clauses or provisions will remain valid and
                            enforceable. Further, the waivers set forth in
                            Section 24.2 are severable from the other provisions
                            of these Terms and will remain valid and
                    ...
                    <p className="c0">
                        <span className="c1">
                            ...
                            in Section 14 does not apply and the Dispute cannot
                            be heard in small claims court, you agree that any
                            action at law or in equity arising out of, or
                            relating to, these Terms shall be filed only in the
                            state and federal courts located in San Francisco
                            County, California and you hereby irrevocably and
                    ...
                    <p className="c0">
                        <span className="c1 h">26. Termination</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                    ...
                    <p className="c0">
                        <span className="c1 h">27. Severability</span>
                    </p>
                    <p className="c0">
                        <span className="c1">
                            If any term, clause or provision of these Terms is
                            deemed to be unlawful, void or for any reason
                            unenforceable, then that term, clause or provision

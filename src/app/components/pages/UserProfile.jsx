           ...
           if( account.comments )
           {
            ...
            if (account.blog) {
                ...
                const emptyText = isMyAccount ? <div>
                    ...
                    <Link to={pathTo.compose()}>{tt('user_profile.create_a_post')}</Link><br />
                    <Link to={pathTo.indexPage('all', 'trending')}>{tt('user_profile.explore_trending_articles')}</Link><br />
                    <Link to={pathTo.welcome()}>{tt('user_profile.read_the_quick_start_guide')}</Link><br />
                    <Link to={pathTo.faq()}>{tt('user_profile.browse_the_faq')}</Link><br />
                </div>:

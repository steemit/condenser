           ...
           if( account.comments )
           {
            ...
            if (account.blog) {
                ...
                const emptyText = isMyAccount ? <div>
                    {tt('user_profile.empty_blog_1')}<br /><br />
                    <Link to="/submit.html">{tt('user_profile.empty_blog_2')}</Link><br />
                    <Link to="/trending">{tt('user_profile.empty_blog_3')}</Link><br />
                    <Link to="/welcome">{tt('user_profile.empty_blog_4')}</Link><br />
                    <Link to="/faq.html">{tt('user_profile.empty_blog_5')}</Link><br />
                </div>:

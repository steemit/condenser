...
const items = [
    ...
    },
    {
        ...
        pic: 'monitor-like',
        description:
            'Каждый день у вас есть 40 голосов чтобы оценить чужие посты. Не упустите их, когда вы нажимаете кнопку «Голосовать за» под постом — топ Golos.io становится интереснее, а вы получаете награду за курирование.',

...
export const YOTIFICATION_MARK_READ = 'yotification_markRead';
export const YOTIFICATION_MARK_ALL_READ = 'yotification_markAllRead';
...
export default function reducer(state = defaultState, action) {
    switch (action.type) {
        ...
        case YOTIFICATION_MARK_READ: {
            const yotifications = state.getIn(['yotifications']);
            const notifications =
                yotifications && yotifications.size > 0
                    ? yotifications.toJS()
                    : [];
        ...
        case YOTIFICATION_MARK_ALL_READ: {
            const yotifications = state.getIn(['yotifications']);
            const notifications =
                yotifications && yotifications.size > 0
                    ? yotifications.toJS()

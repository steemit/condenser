...
export default function reducer(state = defaultState, action) {
    ...
    switch (action.type) {
        ...
        case 'global/UPDATE_ACCOUNT_WITNESS_VOTE': {
        ...
        case 'global/RECEIVE_RECENT_POSTS': {
            const {data} = payload;

...
export const imageProxy = () => config.img_proxy_prefix;

/**
 * Strips all proxy domains from the beginning of the url. Adds the global proxy if dimension is specified
 * @param {string} url
 * @param {string|boolean} dimensions - optional -  if provided. url is proxied && global var config.img_proxy_prefix is avail. resp will be "config.img_proxy_prefix{dimensions}/{sanitized url}"

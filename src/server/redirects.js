...
const redirects = [
    ...
    [/^\/tags\/?$/, '/c/tags'],
    [/^\/tos.html$/, '/s/tos'],
    [/^\/change_password$/, '/c/change-password'],
    [/^\/create_account$/, '/c/create-account'],
    [/^\/approval$/, '/c/approval'],
    [/^\/pick_account$/, '/c/pick-account'],
    [/^\/recover_account_step_1$/, '/c/recover-account-step-1'],
    [/^\/recover_account_step_2$/, '/c/recover-account-step-2'],
    [/^\/market$/, '/c/market'],

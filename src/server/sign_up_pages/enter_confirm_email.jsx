...
export default function useEnterAndConfirmEmailPages(app) {
    ...
    const content = (
      <div className="AuthForm">
        ...
        <div className="Description">
          Your email address, please<br />
          <br />
          <p>
            We use this to contact you and verify account ownership if this
            account is ever compromised. We{"'"}ll send a confirmation link, so
  ...
  router.post('/submit_email', koaBody, function*() {
    ...
    const parsed_email = email.match(/^.+\@.*?([\w\d-]+\.\w+)$/); // eslint-disable-line

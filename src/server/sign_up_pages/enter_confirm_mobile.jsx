...
import CountryCode from 'app/components/Steemit/elements/CountryCode';
...
const assets = Object.assign({}, require(assets_file), { script: [] }); // eslint-disable-line
...
export default function useEnterAndConfirmMobilePages(app) {
    ...
    const content = (
      <div className="AuthForm">
        ...
        <div className="Description">
          ...
          <p>
            With each Steemit account comes a free initial grant of Steem Power!
            Phone verification helps cut down on spam accounts.
          </p>
          <p>
            <em>
              Your phone number will not be used for any other purpose other
              than account verification and (potentially) account recovery
              should your account ever be compromised.
            </em>
          </p>
        </div>
        <form action={'/submit_mobile' + makeParams(params)} method="POST">
          ...
          <div className="error">{this.flash && this.flash.error}</div>
  ...
  router.post('/submit_mobile', koaBody, function*() {
    ...
    //     this.flash = {
    //       error:
    //         "Unfortunately, we don't yet have support to send SMS to your carrier, please try again later.",
    //     };
    ...
    const content = (
      <div className="AuthForm">
        ...
        <form action={'/confirm_mobile' + makeParams(params)} method="POST">
          <div className="FormFields">
            {/* <label>
              Confirmation code

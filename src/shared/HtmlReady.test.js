...
describe('htmlready', () => {
    ...
    it('should not allow links where the text portion contains steemit.com but the link does not', () => {
        ...
        const cleansed = '<xml xmlns="http://www.w3.org/1999/xhtml"><span class="phishy">https://steemit.com/signup / https://steamit.com/signup</span></xml>';
        const res = HtmlReady(dirty).html
        ...
        const cleansedwithuser = '<xml xmlns="http://www.w3.org/1999/xhtml"><span class="phishy">https://official@steemit.com/signup / https://steamit.com/signup</span></xml>';
        ...
        const cleansednoendingslash = '<xml xmlns="http://www.w3.org/1999/xhtml"><span class="phishy">https://steemit.com / https://steamit.com</span></xml>';
